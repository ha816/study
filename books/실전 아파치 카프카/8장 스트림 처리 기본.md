...
이것은 카프카의 메트릭스 기능을 구현하는데 Metrcis 라이브러리를 사용하는 것에 기인한다. Metrics 라이브러리에는 메트릭스가 Gauge,Counter, Histogram, Meter, Timer 등 5종의 종류로 분류되어 있다. 패턴


> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM4NTEyNTU3MiwxODU4NDk4NzMyLDkzND
