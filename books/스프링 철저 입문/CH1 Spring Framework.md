...
EJB는 보안, 트랜잭션 등 EJB 컨테이너의 다양한 서비스를 제공 받기 위해서는 EJB 스펙을 지켜야 했는데, 그 결과  **서비스가 구현해야 하는 실제 비즈니스 로직보다 EJB 컨테이너를 사용하기 위한 상투적인 코드들이 많다는 문제**가 발생하기 시작했죠.
...
이런 문제들이 발생한 이유는 **비즈니스 로직에 특정 기술이 종속되어 있다는 것**입니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNDUyNDAzNzAsLTcwNzEzNTYxOCwzNz
