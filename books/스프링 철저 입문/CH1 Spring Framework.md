...
Java EE(Enterprise Edition)는 일종의 **엔터프라이즈 소프트웨어의 표준**을 말한다. 이런 Java EE 표준을 구현하기 위한 아키텍처가 바로 EJB(Enterprise JavaBeans)이다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQzNzg3ODY0OSwzNzI1NzEzMDcsMTI4Nz
