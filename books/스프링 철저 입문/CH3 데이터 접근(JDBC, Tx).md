...
NEVER, NOT_SUPPORED는 모두 트랜잭션을 관리하지 않는다. 트랜잭션 메서드1의 경계에서 만들어진 트랜잭션이 존재하고 트랜잭션 메서드 2가 NEVER라면 트랜잭션을 절대 쓰지 않는 트랜잭션 메서드2를 트랜잭션 1이 호출하였으므로 예외가 발생한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NzM0NzczNzUsMjY4MTc0NjUxLDE3Mz
