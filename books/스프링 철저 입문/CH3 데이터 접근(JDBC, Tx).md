...
만약 트랜잭션 메서드1 과 2 모두 REQUIRED_NEW라면 메서드1에서 새로운 트랜잭션을 만들고 트랜잭션 2에서도 새로운 트랜잭션을 만든다. 트랜잭션 2는 트랜잭션 1이 끝나고 나서야 트랜잭션 2를 진행한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwODcyNDkwMjYsMTczNjM1MDIzNywxOD
