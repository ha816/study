...
일반적으로는 다수의 데이터를 읽는 Chunk방식이 배치 애플리케이션 구조에는 적합하지만 잘 맞지 않는 경우도 있다. 예를들어 테이블 레코드를 한건만 변경하는 것과 같이 청크 방식이 가져다 주는 성능적인 장점은 얻지 못하는 오히려 복잡한 설계로 인해 단점만 커질 수 있다. 



> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0ODc2MzQyMTMsLTEyOTg4NzI5NDIsMT
