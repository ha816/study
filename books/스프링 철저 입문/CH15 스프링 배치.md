...
스플릿 방식은 처리해야할 다수의 스텝을 여러 스레드로 나누어 작업하는 방식이다. 또한 하나의 스레드에는 여러 스텝들을 연속으로 실행하도록 만들 수 있다.  병렬 처리할 스텝을 세부적으로 지정할 수 있는 장점이 있는 방면 특정 스레드에서 처리해야할 개수가 많아지면 스레드 갯수를 조정하거나 비정상적으로 종료될때 처리가 어려워지는 단점도 있다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgzMzI5MzE4OSwzNDAyMDI3NTgsNTA3MT
Q5NTY2LC0xNDI0NDgxNjg5LC02OTU0OTQwNDEsNTk2OTM3NDg1
LC0yMDI4NjU1ODQzLDE3NzI5NjkzODYsMTc3NTg3MTk2OSwxMz
A4MjU2OTcxLC0xMzA0NjMzNDE5LC0yNzE1ODgwNTEsLTYyODQ2
OTcyMywtMTgyMTAyNDQ1OCwtMTI5ODg3Mjk0MiwxNTU4ODQ5Nj
g4LC0xNDA3MDExMzk2LDkyMjUwOTMyOCwxNzQ2ODQ1MzUyLC0y
MTEyODgwOTg0XX0=
-->