...
스프링 배치는 스프링 배치만의 고유한 빈 스코프가 있다. 바로 Step 스코프와 Job 스코프이다. 각각의 스텝과 잡은 생면주기가 제한되는 싱글턴 빈으로 되어있다. 

ItemReader, ItemProcessor, ItemWriter의 구현체는 



> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwOTYyOTQ1NTYsLTEyOTg4NzI5NDIsMT
