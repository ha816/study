...
스플릿 방식은 다수의 스텝을 여러 스레드로 나누어 작업하는 방식이다. 또한 하나의 스레드에는 여러 스텝들을 연속으로 실행하도록 만들 수 있다.  병렬 처리할 스텝을 세부적으로 지정할 수 있는 장점이 있는 방면 특정 스레드에서 처리해야할 개수가 많아지면 스레드 갯수를 조정하거나 비정상적으로 종료될때 처리가 어려워지는 단점도 있다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIyODI3NjE1LDM0MDIwMjc1OCw1MDcxND
k1NjYsLTE0MjQ0ODE2ODksLTY5NTQ5NDA0MSw1OTY5Mzc0ODUs
LTIwMjg2NTU4NDMsMTc3Mjk2OTM4NiwxNzc1ODcxOTY5LDEzMD
