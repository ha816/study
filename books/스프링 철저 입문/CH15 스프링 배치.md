...
스프링 배치는 **배치 처리르 위한 애플리케이션 프레임워크**이다. 스프링이 가지고 있던 DI 컨테이너나 AOP, 트랜잭션 관리 기능은 기본으로 가지고 있다. 더욱이 앞서 이야기한 배치 처리를 위한 각종 요건을 이미 갖추고 있다. 
...
public class Mypartitioner implements Partitioner {
	...
	public Map<String, ExecutionContext> partition(int gridSize){
		...
		for(int i = 0; i< gridSize; i++){
			...
			execution.putInt(PARTITION_NO_PROPERTY, i);
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MjQ0ODE2ODksLTY5NTQ5NDA0MSw1OT
Y5Mzc0ODUsLTIwMjg2NTU4NDMsMTc3Mjk2OTM4NiwxNzc1ODcx
OTY5LDEzMDgyNTY5NzEsLTEzMDQ2MzM0MTksLTI3MTU4ODA1MS
wtNjI4NDY5NzIzLC0xODIxMDI0NDU4LC0xMjk4ODcyOTQyLDE1
NTg4NDk2ODgsLTE0MDcwMTEzOTYsOTIyNTA5MzI4LDE3NDY4ND
UzNTIsLTIxMTI4ODA5ODQsLTExMTE2NjE5MTQsOTk1MDg0MTYx
LDE4NDE0NzcxNF19
-->