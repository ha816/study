...
상황에 따라 그 상황에 맞는 적절한 인스턴스를 사용할 필요가 있다. 입력 매개변수에 포함된 어떤 상황에 따라서, 정적 팩토리 메서드에서는 적절한 객체를 반환한다. 예를 들어 EnumSet z클래
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMyMTM4MzUyMiwtOTk5MjU4MzIyLDE0NT
