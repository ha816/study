...
Objects 클래스는 임의의 갯수만큼 객체를 받아 해시 코드를 계산해주는 정적 메서드인 hash를 제공한다. 이 메서드를 활용하면 앞서 구현한 코드와 비슷한 수준의 해시함수를 한줄로 작성할 수 있다. 하지만 속도는 느리다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU0OTAxMjUxMCwxMDMxNzg3NDU2LDI4OT
