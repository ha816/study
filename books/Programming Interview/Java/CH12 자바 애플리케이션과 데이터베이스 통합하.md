...
JDBC(Java Database Connectivity)는 데이터 베이스에 연결하기 위한 표준 자바 라이브러리에 내장된 매커니즘이  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MjY1NDE2OTYsMTA0Mjg1NjIwMywtMT
I4NjUzOTExLC0xMTUzNjUzNTIsLTE1ODg3OTIyMzddfQ==
-->