...
쿼리 문자열 `?a=123&b=abc&a=456`을 요청으로 보내면 request의 getParameterMap에는 a: {123,456}, b: {abc} 가 적재 된다. 즉 쿼리 문자열의 키와 값으로 request의 parameterMap을 만든다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIyMjkzMDY0OSwtNjc1MTUzMzc3LC0yMT
