...
톰캣은 몇 가지 구성요소로 이루어져 있는데, 대표적으로 카타리나와 재스퍼가 있다. 톰캣의 핵심 컴포넌트는 카타리나이고 이것이 바로 톰캣의 서블릿 명세의 실제 구현이다. 즉 톰캣을 돌린다는건 카타리나를 돌리는 것이다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA5NTY5MDkwNywtMjExNDM4ODU5Myw3NT
