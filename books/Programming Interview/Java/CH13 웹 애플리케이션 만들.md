...
기본으로 실행 중인 톰캣 인스턴스는 webapps 디렉터리에서 일어난 변화를 감지한다. 예를 들어 BookingApplication.war라는 WAR파일을 webapps 디렉터리에 배포하면 그 파일은 Bo
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMzMzkxMjM1MCwtMjExNDM4ODU5Myw3NT
