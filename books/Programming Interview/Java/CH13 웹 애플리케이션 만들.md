...
실행 중인 톰캣 인스턴스는 webapps 디렉터리에서 일어난 변화를 감지한다. 예를 들어 BookingApplication.war라는 WAR파일을 webapps 디렉터리에 배포하면 그 파일은 BookingApplication 디렉터리에 압축을 푼다. 탐캣은 WEB-INF 하위에 있는 web.xml 파일 읽고 정의대로 애플리케이션을 실행하고 /BookingApplication 경로를 통해 클라이언트에 제공한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIwMjU2ODU3LC0yMTE0Mzg4NTkzLDc1Mz
c5NTE3OSw0NDkxNjk5OSwtNjIwNzY5MTIyLC0xMTE3NjQxMjkx
LDE2NTE4Mjg0NjUsLTE0MjA0OTA2NjUsLTM5MjI5NzE5LC02MD
ExNjI5ODMsNzA5OTgxNjY4LC0xOTI2NTgwMjA0LDUzMjMyMDA5
NiwxNzUzNzQ4ODEyLDY0NDUxNDQ1NywxMzAxNTIyNjE1LC0xNT
