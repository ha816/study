...
Executor 인터페이스: 주어진 Runnable객체의 실행을 execute담당; 태스크(task)는 우리가 수행해야할 Runnable 객체를 말한다. 
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgzMDU5MTI0LDE3MTIyMTQ0OTksLTIwNz
AwMjgyNDUsMTQ1OTEyMDMyNywtODIzNTU0NjJdfQ==
-->