...
* 다수의 데코레이터 결합을 통해 기능을 동적으로 유연하게 확장 할 수 있게 해주는 패턴.
* 기본 기능에 추가할 수 있는 기능의 종류가 많은 경우에 추가 기능을 데코레이터 클래스로 정의 한 후 필요한 Decorator 객체를 조합함으로써 추가 기능
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjgzMTA4NzM0LDQ0OTQ4OTAyNCwxOTM0ND
YxNjksLTIwODM2NzkwMDYsMjEzNzE1NzMxNiwtMjA2MTQ4MDU4
MiwtMzMwODIwODY4LDIxMTE0MjM1OTIsMjEyMzExMjcwNl19
-->