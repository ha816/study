...
BufferedOutputStream 클래스는 파일을 저장하는데 필요한 작업을 버퍼에 쌓아두고 캐시하고 한번에 여러 바이트씩 저장한다. 이렇게 하면 디스크에 파이을 저장할대 효율이 크게 향상된다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM1NjAxMDEwNSwtMTAzMDczNTI4MCwtMj
