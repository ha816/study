...
Object 클래스에 정의된 hashCode()는 객체의 내부 메모리 주소를 integer값으로 반환한다. 

해시 함수를 자바는 Object 클래스에 정의된 hashCode()로 구현한다. hashCode로 계산된 값은 해시 테이블 인덱스를  어디에 키-값 쌍이 있는지 확인하는데 사용된다 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMjg0MDMxMTEsMTU3MDU0MjMyNiwzMT
