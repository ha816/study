...
해시 충돌이 일어나는 얼마나 자주 일어날것인지는 테이블의 크기와 밀접한 연관이 있다. HashMap은 객체를 생성할 때 0에서 1값을 가지는 부하계수를 명시 할 수 있다. 그리고 이 부하 계수를 다 채우게 되면 테이블의 크기를 두배로 늘린다. 이때 테이블의 원소를 재배치하는데,  해시 값을 테이블 이
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzk1NDM0MTc5LC0xMDgwNzQ4Mzc3LC0xMj
