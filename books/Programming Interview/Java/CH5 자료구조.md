...
이러한 해시함수를 자바에서 구현한것이 바로 Object 클래스에 정의된 hashCode 메서드이다. 메서드를 호출한 객체의 내부 메모리 주소를 integer값으로 반환한다. 바로 이 hashCode()가 자바에서 구현한 hash function이다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc5MzU5NTg2MywxNTcwNTQyMzI2LDMxOD
