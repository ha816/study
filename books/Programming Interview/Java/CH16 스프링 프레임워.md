...
설정자 기반 의존성 주입 방식(setter-based dependency injection)
: 세터 메서드를 사용해서 필요한 의존성이 주입된 객체를 만드는 방법. 자바 기반 설정 방식으로는 @Bean 애너테이션을 붙은 Bean 생성 메서드에서 필요한 객체를 만들고 세터메서드로 의존 주입을 통한 객체를 반환한다. XML 기반 설정 방식으로는 propery 요소에 name 속성으로 대상의 이름을 지정하면 된다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ0OTE2MzU1OSwtMTM3OTAyNjAzNCwxOD
cwMzkzMDE0LC0xNzAwMDQ0MDgyLC0xNzgzOTAyNDUsMjEyNzg3
MzI5MywtMzI4NjA1NTc1LC0zMDI5NDMzOCwtMTk1MzY4ODkzOC
wyMDY2MTIzNjc3LDIxNDE4MzQ4ODMsLTM5MjI3MzczOSwtMzgx
NjM3MTcsLTE0NDQ2Nzg2MzJdfQ==
-->