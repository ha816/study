...
설정자 기반 의존성 주입 방식(setter-based dependency injection)
: 메서드를 사용해서 필요한 의존성을 주입하는 방식. @Bean 애너테이션을 붙은 Bean 생성 메서드에서 필요한 의존 객체를 만들어 반환한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MDAwNDQwODIsLTE3ODM5MDI0NSwyMT
I3ODczMjkzLC0zMjg2MDU1NzUsLTMwMjk0MzM4LC0xOTUzNjg4
OTM4LDIwNjYxMjM2NzcsMjE0MTgzNDg4MywtMzkyMjczNzM5LC
0zODE2MzcxNywtMTQ0NDY3ODYzMl19
-->