...
애너테이션 기반 설정 방식
이 방법은 DI 컨테이너에서 관리할 빈 자체에 빈을 정의하는 애너테이션을 부여한다. 이 애너테이션이 붙은 클래스를 탐색해서 DI 컨테이너에 자동으로 등록하는데 이를 컴포넌트 스캔(Component Scan)이라고 한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyODE3MzY4MTIsLTMwMjk0MzM4LC0xOT
UzNjg4OTM4LDIwNjYxMjM2NzcsMjE0MTgzNDg4MywtMzkyMjcz
NzM5LC0zODE2MzcxNywtMTQ0NDY3ODYzMl19
-->