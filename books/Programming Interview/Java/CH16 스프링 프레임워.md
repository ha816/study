...
|방법| 설명 |
|--|--|
|자바 기반 설정 방식(Java-based configuration  | 자바 클래스에 @Configuration  |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NTM2ODg5MzgsMjA2NjEyMzY3NywyMT
QxODM0ODgzLC0zOTIyNzM3MzksLTM4MTYzNzE3LC0xNDQ0Njc4
NjMyXX0=
-->