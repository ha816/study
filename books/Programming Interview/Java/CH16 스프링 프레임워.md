...
설정자 기반 의존성 주입 방식(setter-based dependency injection)
: 메서드를 사용해서 필요한 의존성을 주입하는 방식. @Bean 애너테이션을 붙은 메서드에서 Bean 생성 메서드에서  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYyNjgzNjYyMywtMTc4MzkwMjQ1LDIxMj
c4NzMyOTMsLTMyODYwNTU3NSwtMzAyOTQzMzgsLTE5NTM2ODg5
MzgsMjA2NjEyMzY3NywyMTQxODM0ODgzLC0zOTIyNzM3MzksLT
M4MTYzNzE3LC0xNDQ0Njc4NjMyXX0=
-->