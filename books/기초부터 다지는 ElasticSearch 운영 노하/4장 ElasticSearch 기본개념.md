...
세그먼트는 불변의 특성을 갖는다. 즉 ES는 데이터를 수정하려고 하면 새로운 세그먼트에 새롭게 업데이트된 문서를 쓰고, 기존 문서는 불용 처리한다. 이 동작은 delete도 마찬가지인데 불용처리만 한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEzNTE5NTI5OSwyMTA1Nzc4MDk5LDEwND
