...
Monitoring에서는 클러스터의 Health 상태, 노드의 개수, 인덱스 개수등을 볼 수 있다. Overview를 보면 초당 발생하는 색인의 양, 그리고 성능을 의미하는 Latency등을 간략하게 볼 수 있다. 
...
이번 장에서는 Head, 프로메테우스, X-Pack을 이용한 모니터링 시스템을 살펴보았다. 다양한 지표들이 어떤 의미인지는 7장에서 자세히 다룰것이고, 알아보았던 모니터링에서 어떤 시스템을 설치하고 사용하는 방법의 장단점을 파악해 어느것을 사용할지 판단하면 된다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzQxMTA4MTM5LC0xNTkxMTU4MjAxLC0xMj
