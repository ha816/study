...
ES가 실행되면 "10.10.10.10"인 서버에 ES가 동작 중인지 확인한다. 그리고 서버로 부터 현재 구축된 클러스터 정보를 가져온다. 만약 10.10.10.10 서버가 현재 이미 다른 클러스터에 합류한 상태라면 해당 클러스터에 대한 모든 정보를 받아온다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAyOTU4NDMsNzQ0NzEyMDM3LDE4OTE4OD
IyNjYsLTMyNzgzMjU0MSwtMTg0ODg2OTUyMSwtOTE1NDIxMTM1
LC05MTUxNzg1NTIsMTMyNzE0MzY4LDE2ODA5MjMwMDIsMTA2OD
