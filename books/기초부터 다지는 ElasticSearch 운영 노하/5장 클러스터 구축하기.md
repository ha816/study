...
이 상황에서 네트워크 장애가 발생하여 하나의 마스터 노드와 나머지 두 대의 마스터 노드간의 통신 연결이 발생했다고 하자. 그러면 서로 다른 마스터 노드를 가진 두 개의 클러스터가 생겨날 수도 있다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTk3NDQwOTE3LC0yODQwOTI3NjAsLTEyOD
