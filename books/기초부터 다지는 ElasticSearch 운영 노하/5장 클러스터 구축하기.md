...
1. 마스터 노드는 클러스터 전체 메타 데이터를 관리하며, 클러스터 내에선 반드시 한대 이상이 존재해야 한다. 클러스터의 안정성을 위해서 minimum_master_nodes를 과반수로 설정할 수 있도록 홀
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA1MDc1MzUxNSwtMTc5Nzg3MTMwMSwtMT
