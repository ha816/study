...
이럴땐 해결방법으로 network.host를 0.0.0.0으로 설정하면 된다. 0.0.0.0으로 설정하면 ES가 bind_host로  10.10.10.10과 127.0.0.1 두 IP를 모두 사용할 수 있도록 해준다. 이 덕분에 localhost 내부 도메인으로 API를 호출할 수 있게 된다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQwMzM3MjU4MiwxODI2NTEzODUzLC00NT
