...
Mono<User> requestUserDate(String sessionId){
	return isValidSession(sessionId)
		? Mono.fromCallable(() -> requestUser(sessionId))
		: Mono.error(new RuntimeException("Invalid user session"));
// requestUserDate 메서드가 호출될때 마다  호출될때 유효성 검사를 수행합니다.
// 실제 구독 이전에도 호출할 수 있습니다.(구독이 전혀 발생하지 않을수도)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzI3NzA0MjI1LDE2NTk2MzE1OTcsNzYzNj
MyNzEsNjA1NDMwNDgyLDgwOTM3NDg5MCwtNzk1MDA4MDMyLDUx
MzM0ODY2NCwtMTAwNDExODgyNiwyMDc4MDk3NzQxLC0xNTk5ND
E1NjM3LDY2NTU4OTUyNiwxMjQwNDI1NDY2LC0zODYwMzYyOSwt
MTMzOTIxODM3NywtMTE2MDY5OTU3Nyw4ODk2NjQxOTQsMTQ4ND
E4MTUxLDcxODM3NzgyMSwtMTEyNTYxNDc3NCwtMTUyODQ1MTUx
NV19
-->