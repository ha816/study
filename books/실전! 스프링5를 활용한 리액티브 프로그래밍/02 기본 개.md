...
// mono로 데이터가 
// supplies the resulting `Mono` instance. The evaluation of this expression is deferred until somebody subscribes 
Mono<User> requestUserDate(String sessionId){
...
```
defer는 구독하는 순간에 행동을 결정하는 시퀀스를 생성하는 메서드로, 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI0MzYyMzE4NywxNjU5NjMxNTk3LDc2Mz
YzMjcxLDYwNTQzMDQ4Miw4MDkzNzQ4OTAsLTc5NTAwODAzMiw1
MTMzNDg2NjQsLTEwMDQxMTg4MjYsMjA3ODA5Nzc0MSwtMTU5OT
QxNTYzNyw2NjU1ODk1MjYsMTI0MDQyNTQ2NiwtMzg2MDM2Mjks
LTEzMzkyMTgzNzcsLTExNjA2OTk1NzcsODg5NjY0MTk0LDE0OD
QxODE1MSw3MTgzNzc4MjEsLTExMjU2MTQ3NzQsLTE1Mjg0NTE1
MTVdfQ==
-->