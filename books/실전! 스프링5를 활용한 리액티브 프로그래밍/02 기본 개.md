...
error(Throwable) 은 구독할때 각 구독자의 onError() 메서드를 통해 항상 오류를 전파하는 시퀀스를 생성합니다. 오류는 Flux또는 Mono선언 중에 생성되므로 각 구독자는 동일한 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTkxNDQ1NjE4LDUxMzM0ODY2NCwtMTAwND
...
MSwtMTEyNTYxNDc3NCwtMTUyODQ1MTUxNV19
-->