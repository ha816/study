...
하지만 비동기 논블러킹 모델도 문제가 있습니다. 우선 CPU를 많이 사용하는 작업은 별도의 쓰레드 더 나아가 별도의 쓰레드풀을 가져야 합니다. 사실 이 문제는 기존 스레드 풀 모델이나 연결당 새로운 쓰레드를 할당하는 기존 모델에서는 발생하지 않습니다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ2MDI0MTg4NCw5NTM2ODIxMSwtMTYwND
