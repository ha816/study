...
좀 더 구체적으로는 애플리케이션에 탄력성(elasticity)을 부여하는 것입니다. 탄력성이란 작업 부하에서 응답성을 유지하는 능력. 즉 많은 사용자 요청이 들어올때는 탄력적으로 시스템 처리량이 늘어나야하고 수요가 감소하면 자동으로 감소해야 한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ1NzE1NDg2NSwyMDA4MzYwNDQ3XX0=
-->