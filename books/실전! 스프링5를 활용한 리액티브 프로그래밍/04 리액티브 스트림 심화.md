...
주의할 점으로 parallel()만을 사용하면 Flux데이터를 CPU 코어 개수만큼의 ParallelFlux로 나누고 라운드로빈 방식으로 처리하게 됩니다. 즉 의도한 병렬처리가 되지 않습니다. 따라서 .runOn을 사용해서 특정 스케쥴러를 명시하지 않으면 의도한 병렬 수행이 동작하지 않으므로 반드시 runOn으로 특정 스케쥴러를 지정해야 합니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODcwNDE3MjAsMTU2NjEwODE5MCwyMDc2OT
I1ODk4LC0xODk3NTczOTY2LC0xNDcyMzMzNTY2LDQwOTE5NDA2
MywxNzE5MjgxNjcsLTU0NjczOTAsLTc4MzE5NDk5NywxMzE3ND
ExNTQ4LDE2NTYyNjQxODEsLTg3MDMyOTY2MF19
-->