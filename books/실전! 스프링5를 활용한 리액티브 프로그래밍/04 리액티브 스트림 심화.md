...
Mono.fromCallable은 Callable을 인자로 받아 Mono를 생성하고 실행 결과를 내부적으로 가지는 새로운 구독자에게 전달합니다. 이러한 과정이 메인쓰레드와는 별개로 독립적으로 비동기적으로 동작하게 됩니다.  

```
public void subscribe(Subscriber actual) // actual 구독자
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDA5MTk0MDYzLDE3MTkyODE2NywtNTQ2Nz
M5MCwtNzgzMTk0OTk3LDEzMTc0MTE1NDgsMTY1NjI2NDE4MSwt
ODcwMzI5NjYwXX0=
-->