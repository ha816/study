...
publishOn과는 달리 subscribeOn을 사용하면 구독 체인에서 쓰레드 작업 위치를 변경할 수 있습니다. (구독 단계; subscribe())


동작하는 스케줄러를 지정할 수 있습니다. 구독체인에서 워커의 작업 위치를 변경할 수 있습니다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY2NzI2MDQ1LC03ODMxOTQ5OTcsMTMxNz
