...
좀 더 구체적으로는 애플리케이션에 탄력성(elasticity)을 부여하는 것입니다. 탄력성이란 작업 부하에서 응답성을 유지하는 능력. 즉 많은 사용자 요청이 들어올때는 탄력적으로 시스템 처리량이 늘어나야하고 수요가 감소하면 감소해야 한다는 것을 말합니다.  시스템 처리량을 늘릴려면 수평적 또는 수직점으로 확장을 통해 탄력성을 높일 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk2MTc1NDMzXX0=
-->