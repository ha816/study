...
리액티브(반응성)이란 용어를 최근 빈번하게 들을 수 있습니다. 리액티브란 프로그래밍 모델의 일종입니다. 

리액티브를 이해하기 위해선 탄력성과 복원력을 이해할 필요가 있습니다. 
리액티브 프로그래밍이란 구체적인 리액티브한 시스템을 구축하기 위한 프로그래밍을 말합니다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc1OTQwMzU3Ml19
-->