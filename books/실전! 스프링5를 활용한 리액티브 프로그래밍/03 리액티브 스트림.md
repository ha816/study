...
하거나 Flux.all(Predicate)으로 모든 원소가 필요한 속성을 갖는지 확인할 수 있습니다. 
Flux.any(Predicate)로 하나 이상의 조건을 만족하는 원소가 있는지 확인 가능합니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1OTU2Nzc1NjEsLTYyNzQwMTg3MCwtMT
