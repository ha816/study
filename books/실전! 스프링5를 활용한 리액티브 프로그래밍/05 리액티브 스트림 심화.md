...
이 단계에서 Publisher와 Subscriber가 onSubscribe() 시그널과 request() 시그널을 교환하면서 스트림 실행이 시작된다. 위 예제에서 최상위 subscriber는 ArraySubscriber이므로 거기서부터 onSubscribe()가 전파된다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg3NDU0MTA1MSwtMTYyODIwMjk5OCwxMz
