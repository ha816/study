...
빈 컨테이너가 제공하는 빈을 특정 클래스에서 사용하고 싶어 의존성 주입을 받을때 사용하는 방법이다. @Autowired을 필드나 메서드, 생성자에 붙이면 빈컨테이너로 부터 필요한 객체를 주입받을 수 있다. 



<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY2MjA4OTczMSwtMTI0NDA4OTQxMiwtMT
I1OTQ5NjE0MSwxMDc2MjYxMDI1LC02MDM4NjQ3MywtNzg2MDQ3
MTldfQ==
-->