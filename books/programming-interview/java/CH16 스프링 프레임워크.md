...
```
ApplicationContext context = new WepApplicationContext(config.class); //config 클래스는 @Configuration 애너테이션을 붙인다. 


ApplicationContext context = new WepApplicationContext(config.class);


```

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNjk3NjkzNTcsLTc4NjA0NzE5XX0=
-->