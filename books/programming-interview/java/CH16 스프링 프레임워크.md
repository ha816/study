...
```
컴포넌트 스캔 설정 방식은 컨테이너로 하여금 어떤 영역을 스캔을 할건지 알려줘야 한다. 스캔 영역을 알려줄때는 자바기반 설정과 XML기반이 있다. 자바기반에서느 

이나사용될 클래스에는 @Componet, @Repository, @Service, @Controller와 같은 애너테이션을 붙인다.



<!--stackedit_data:
eyJoaXN0b3J5IjpbNjQ0MzUyOTU3LDEwNzYyNjEwMjUsLTYwMz
g2NDczLC03ODYwNDcxOV19
-->