...
```
ApplicationContext context = new Annotation(config.class); //config 클래스는 @Configuration 애너테이션을 클래스 상단에 붙이고 @Bean 애너테이션을 사용할 객체를 생성하는 메서드마다 붙인다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg4MzkyMzE4MCwxMDc2MjYxMDI1LC02MD
