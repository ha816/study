...
* 기본 클래스(Component)에 기능이 너무 많은 경우,  기본 기능을 제오 일부 기능을 데코레이터 클래스에 정의 한다. 그리고 기본 객체와 데코레이터 객체를 조합하여 원하는 기능을 사용한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE5NDMxNTM1OCwxMjIxNjc1MzI0LC0yMD
