...
웹에 공개할 리소스에 그 리소스를 고유하게 식별할 수 있는 URI(Universal Resource Identifier)를 할당한다면 만약 URI를 안다면 어디서든 같은 리소스에 접근이 가능하다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzQwNzIyODQ5LDE0MDYxMjc1NjcsLTE5OT
g5NTE2MjZdfQ==
-->