...
따라서 만약 URI를 안다면 어디서든 같은 리소스로 접근이 가능하다. 한 URI는 리소스 하나 나아가 다수의 리소스로 정의가 가능하다. 예를 들어 user/1234는 가 1234인 사용자의 세부정보. /users는 모든 사용자의 목록일것으로 생각할 수 있다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5Njk5NDcyMTMsMTQwNjEyNzU2NywtMT
k5ODk1MTYyNl19
-->