...
REpresentational State Transrfer 줄여서 REST라고 부른다. 사전적 의미로 보면 '대세의 추상적 상태 전송'인데 사실 와닿는 말은 아니다. 그보다는 REST를 아래와 같은 의미로 이해하도록 하자. **시스템간 통신 API를 만드는데 HTTP를 활용하도록 하는 규격이다.** 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNDk5NTI5NDBdfQ==
-->