...
REST 아키텍처 스타일에서 가장 중요한 것은 **리소스**라는 개념이다. REST API는 관리하고 있는 정보에서 클라이언트에 제공할 정보를 '리소스'의 형태로 제공한다. 제공된 리소스는 웹에 공개되고 리소스에 CRUD 조작을 위한 수단으로 

Resource Oriented Architecture(ROA)는 Restful 웹 애플리케이션을 구축하기 위한 구체적인 정의를 하고 있다. 



## 
REST의 목적 중 하나는 이미 널리 사용하는 HTTP 프로토콜을 사용하여 손쉽게  API 통신을 하는 것이다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc1NzU3Mjc1M119
-->