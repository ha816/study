...
따라서 만약 URI를 안다면 어디서든 같은 리소스로 접근이 가능하다. 
URI는 묶음도 될 수 있다. 예를 들어 user/1234는 ID가 1234인 사용자의 세부정보. /users는 모든 사용자의 목록일것으로 생각할 수 있다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI4NjQwMTUwMiwxNDA2MTI3NTY3LC0xOT
k4OTUxNjI2XX0=
-->