...
HTTP 메서드는 마치 자연어에서 동사와 같은 역할을 한다. 웹 서버에 요청한 자원에 대해서 구체적으로 어떤 동작을 할지 알리는 역할을 한다.  
서버가 일반적으로 구현하는 메서드 중 HEAD, GET, POST는 필수적인 메서드이다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MDQwOTI5NzAsLTE5OTg5NTE2MjZdfQ
==
-->