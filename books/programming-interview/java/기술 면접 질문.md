...
>데드락 처리는?
>데드락 처리에는 예방(Prevention) 및 회피(Avoidance) 방법과 탐지 및 회복(Detection & Recover) 방법이 있다. 
>예방은 교착 상태 발생 조건 중 하나를 제거함으로써 해결하는 방법으로 자원의 낭비가 심하다. 회피는 데드락이 발생하면 은행원 알고리즘 (Banker’s Algorithm)을 통해 피해간다.
...
출처: [https://includestdio.tistory.com/12](https://includestdio.tistory.com/12) [includestdio]
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MjE2NTI0MDQsLTE2NjE5MDM3NjgsMT
Y1Njk5ODY2MiwxNzcyNzY5ODgyLC01OTM4NzE3NzBdfQ==
-->