...
> WAS와 Web Server의 차이
> WAS(WebApplication Server)의 약자로 동적인 웹 서비스를 제공하는데 사용한다. Tomcat이 대표적인 WAS이다.
> Web Server는 정적인 웹 서비스를 제공하며, WAS에 비해 기능이 가볍다. 아파치 서버가 대표적인 WebServer이다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwODM4MDU4NTMsLTE2NjE5MDM3NjgsMT
