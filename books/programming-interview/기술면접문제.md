...
>파티셔닝이란 데이터를 테이블로 분리해서 저장하지만 사용자 입장에서는 여전히 하나의 테이블로 
>퍼포먼스(performance), 가용성(availability) 또는 정비 용이성(maintainability)를 목적으로 당신의 논리적인 데이터 엘리먼트들을 다수의 엔티티(table)로 쪼개는 행위를 뜻하는 일반적인 용어이다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNzkzMjkzMjEsMTYyNDQ3NTM4MywxMT
gwNjAwNDg0LDE0NTQ5NTUzMTAsMTgyOTIzNjUwNiwtMjA5NTEw
MDQzNywtMTY3NjMzMTY5MCwxNzgyNTIzMjI5LDEwMDQ1MTkxMj
gsMTA2Njc1NTA4NSwtMTg0MDI1MTI4Miw1NzIxNjg5MDAsMTUz
NjUxODc5LC0zMDU4OTE1OTMsMTgyNDIxMDQ5NiwtMTM0Mjc4NT
U3LC0xMzQ1MTcxMjMyLDE4MTM5NDE4MDEsOTk5NTUyOTQsMTY2
MDAzMzgxMF19
-->