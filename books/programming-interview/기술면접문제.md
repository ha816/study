...
>Shard는 도자기의 파편이라는 의미로 Sharding은 수평 파티셔닝을 일컫는 말이다. Shard를 만들려면 Sharding key를 정하고 키를 기준으로 샤딩을 나누어야 한다. **MySQL의 파티션 테이블에서 인덱스는 전부 로컬 인덱스에 해당한다.** 모든 인덱스는 파티션 단위로 생성되며, 파티션에 관계없이 테이블 전체 단위로 글로벌하게 하나의 통합된 인덱스는 지원하지 않는다
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYzMDk5OTMzMCwxMzIyMTA3Njc0LDE1Nz
gzMTgxNjIsLTQxMjY4NDE1NCwtNzQ5ODkzMDg5LC00NzI3NDA3
NTEsMTYyNDQ3NTM4MywxMTgwNjAwNDg0LDE0NTQ5NTUzMTAsMT
gyOTIzNjUwNiwtMjA5NTEwMDQzNywtMTY3NjMzMTY5MCwxNzgy
NTIzMjI5LDEwMDQ1MTkxMjgsMTA2Njc1NTA4NSwtMTg0MDI1MT
I4Miw1NzIxNjg5MDAsMTUzNjUxODc5LC0zMDU4OTE1OTMsMTgy
NDIxMDQ5Nl19
-->