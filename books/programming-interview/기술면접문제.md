...
> HTTP2는 성능과 속도 모두 뛰어나다. Multiplexed Streams(한 커넥션에 여러개의 메세지를 동시에 주고 받을 수 있음), Stream Prioritization(요청 리소스간 의존관계를 설정), Server Push(HTML문서상에 필요한 리소스를 클라이언트 요청없이 보내줄 수 있음), Header Compression(Header 정보를 HPACK압충방식을 이용하여 압축전송)을 사용하여 선을을 획기적으로 향상 시켰습니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NDQzNzk0MDgsMTQ1MjMzNzY5MCw3Mz
Y5NjMwMTIsMjA1NzY4ODcxNywtNjUzMDU1Mjk4LC0xNDI5MDk0
MjYzLC0yNzE2ODYyMzksLTE1MTk4NzYwNzEsODQzNjk1MjMyXX
0=
-->