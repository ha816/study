...
>트랜잭션이 만족하려면 ACID를 만족해야 한다. 원자성, 일관성, 독립성, 견고성. 원자성은 트랜잭션의 작업이 모두 완료되거나 아예 실패가 되는 성질을 말한다. 일관성은 작업 완료 후 모든 데이터의 정합성이 맞아야 한다.  독립성은 다수의 트랜잭션에서 작업을 실행할 경우 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU5NjM0Nzk5NCwxNTM2NTE4NzksLTMwNT
