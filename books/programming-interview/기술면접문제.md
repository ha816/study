...
>트랜잭션이란? 트랜잭션의 성질?
>Transaction은 여러 작업을 묶어 하나의 작업 단위로 만든 것을 말한다. 트랜잭션이 성립하려면 ACID성질을 만족해야 한다. 원자성, 일관성, 독립성, 견고성. 원자성은 트랜잭션의 작업이 모두 완료되거나 아예 실패가 되는 성질을 말한다. 일관성은 작업 완료 후 모든 데이터의 정합성이 맞아야 한다.  독립성은 다수의 트랜잭션에서 작업을 실행할 경우 순차적으로 처리가 되어야 한다. 견고성은 트랜잭션이 커밋되고 나면 어떤 비상사태에서도 데이터가 안전히 남아 있어야 한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMDI2MjI3MzksMTUzNjUxODc5LC0zMD
U4OTE1OTMsMTgyNDIxMDQ5NiwtMTM0Mjc4NTU3LC0xMzQ1MTcx
MjMyLDE4MTM5NDE4MDEsOTk5NTUyOTQsMTY2MDAzMzgxMCwtNT
UzNTQxMjc2LC0xNjQ0Mzc5NDA4LDE0NTIzMzc2OTAsNzM2OTYz
MDEyLDIwNTc2ODg3MTcsLTY1MzA1NTI5OCwtMTQyOTA5NDI2My
wtMjcxNjg2MjM5LC0xNTE5ODc2MDcxLDg0MzY5NTIzMl19
-->