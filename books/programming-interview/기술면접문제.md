...
>**URL?**
>url(Uniform Resource Locator)이다. 클라이언트에 공개하는 리소스의 위치자를 말한다. URI는 URL을 포함하는 더 큰 개념이라는걸 기억하자!
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MjkwOTQyNjMsLTI3MTY4NjIzOSwtMT
UxOTg3NjA3MSw4NDM2OTUyMzJdfQ==
-->