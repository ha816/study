...
>엔터프라이즈 시스템은 기본적으로 복잡한 시스템이다. 그래서 스피링이 2000년대에 나타나기 전에 무수히 많은 엔터프라이즈 프로젝트가 실패했다. 스프링를 DI, AOP, PSA를 통해 극복했 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc1MTkxOTYyOSwtMTgzODY4MDU0OCwtNT
