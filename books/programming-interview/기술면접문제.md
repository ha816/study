...
>Statement는 사용하는 쿼리문 자체를 DB서버에 보낸다. 때문에 SQL Injection에 취약하며 사용하는 쿼리가 비슷하더라도 성능 이점을 얻을 수 없다. PreparedStatement 쿼리에는 바인딩 변수를 사용할 수 있다. 템플릿화 된 쿼리를 DB서버에 미리 알려주고 파싱된 쿼리를 요청마다 재사용하여 반복적인 쿼리 수행시 성능상 이득이 있다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU5NDQxMDE3MCwtMTY3NjMzMTY5MCwxNz
gyNTIzMjI5LDEwMDQ1MTkxMjgsMTA2Njc1NTA4NSwtMTg0MDI1
MTI4Miw1NzIxNjg5MDAsMTUzNjUxODc5LC0zMDU4OTE1OTMsMT
gyNDIxMDQ5NiwtMTM0Mjc4NTU3LC0xMzQ1MTcxMjMyLDE4MTM5
NDE4MDEsOTk5NTUyOTQsMTY2MDAzMzgxMCwtNTUzNTQxMjc2LC
0xNjQ0Mzc5NDA4LDE0NTIzMzc2OTAsNzM2OTYzMDEyLDIwNTc2
ODg3MTddfQ==
-->