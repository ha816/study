...
>**URL?**
>url(Uniform Resource Locator)이다. 클라이언트에 공개하는 리소스의 대략적인 위치를 알려준다. 예를들어 https://www.google.co.kr/search?q=uri가 있다고 하자. 여기서 URL은 https://www.google.co.kr/search까지이고, 실제 리소스는 ?q=uri라는 쿼리 스트링이 필요하다.  https://www.google.co.kr/search?q=uri 주소는 URI이지만 URL은 아니다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE4MjQ5MjQ3OCwtNjUzMDU1Mjk4LC0xND
