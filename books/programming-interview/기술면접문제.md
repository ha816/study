...
>**REST란?**
>REpresentional State Transfer의 약자로 시스템간 API를 만드는데 활용하는 아키텍처 스타일의 일종이다. REST에서 가장 중요한 것은 리소스인데, 리소스는 클라이언트에 공개할 가공된 정보를 말한다. 리소스는 웹에 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4OTA0NjgxMTQsODQzNjk1MjMyXX0=
-->