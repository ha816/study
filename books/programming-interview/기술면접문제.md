...
>**URL?**
>url(Uniform Resource Locator)이다. 클라이언트에 공개하는 리소스의 대략적인 위치를 알려준다. 사실 URI는 URL 보다 큰 개념인데, 우리가 실제 알고 싶은 리소스는 URI이고 URL은 URI 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MDQxOTE0MzAsMjA1NzY4ODcxNywtNj
