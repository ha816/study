...
>자바의 변수의 종류는? 
> 변수가 가지는 값의 종류에 따라 참조 변수(reference variable), 원시 변수(primitive variable)가 있다. 그리고 클래스에 선언한 위치에 따라서 멤버 변수, 로컬 변수로 나뉜다. 멤버 변수는 다시 레퍼런스 변수와 클래스변수로 나뉘는데 클래스 변수는 St
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTk4ODM3NDg0LDM0ODIyODM4NiwtMzI3OT
c2NjQwLC0xODY4OTc3NDI3LC05NjAwODk3NDksOTU0NDM5Nzgy
LC04MDY5NTE3NDQsLTkyMzc3MzM5LC0xNzAwNzQ2MzYxLC02ND
U0OTQ5MDIsLTQxNjYxOTY2MywyMDE5MzgwNzEsNzQxMjk1NTYz
LDE1NTYwNTQ2MTAsLTM1MTQwMzkwMiwtOTU1NjU1NTc3LDE5MT
