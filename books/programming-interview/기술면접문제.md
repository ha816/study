...
> 패키지 중 java.concurrent.atomic 을 살펴보면 원자적 연산을 수행할 수 있는 유용한 클래스들을 확인할 수 있다. Lock이나 Synchronized 키워드 없이도 비교 후 치환(CAS, Compare and swap)을 통해서 쓰레드 세이프한 처리가 가능하다. CAS 기반의 클래스가 락 기반의 클래스보다 성능이 훨씬 좋고,
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MDM2MjMwNjIsOTc4MTE1OTEzLDc2OD
M5ODQyOSwxNjE4MzYxMzU0LDI5NTAyMzExOCwxMjc0MjUzMjA1
LC0xNjY5NDgxOTcsLTE2Mjc4NzAzMTQsLTE3MjY0MDQyNTgsLT
