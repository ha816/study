...
>**URL?**
>url(Uniform Resource Locator)이다. 클라이언트에 공개하는 리소스의 대략적인 위치를 알려준다. 최종 목적지는 URI이고 그 과정에 URL를 거쳐 간다. 따라서 URI는 URL을 포함하는 큰 개념이다. 왜냐하면 모든 URL은 결국 URI에 포함되기 때문이다. 
> 예를들어 https://www.google.co.kr/search?id=123가 있다고 하자. 여기서 URL은 https://www.google.co.kr/search까지이고 실제 리소스는 https://www.google.co.kr/search?id=123 주소는 URI이지만 URL은 아니다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMjE0NjM0MjQsMjA1NzY4ODcxNywtNj
UzMDU1Mjk4LC0xNDI5MDk0MjYzLC0yNzE2ODYyMzksLTE1MTk4
NzYwNzEsODQzNjk1MjMyXX0=
-->