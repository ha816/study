...
>**TCP와 UDP의 차이는?**
>TCP는 발신지와 수신지를 연결하여 패킷을 전송하기 위한 논리적 경로를 고정한다. 3-way handshaking은 목적지와 수신지를간 정확한 전송을 보장을 위해 세션을 수립하는 과정이다.  TCP는 패킷의 전송 순서를 지키고, 패킷의 손실이 없기 때문에 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk2OTkxMTM4MiwtNTUzNTQxMjc2LC0xNj
