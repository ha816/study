...
>트랜잭션이란? 트랜잭션의 성질?
>Transaction은 여러 작업을 묶어 하나의 작업 단위로 만든 것을 말한다. 
>트랜잭션이 만족하려면 ACID를 만족해야 한다. 원자성, 일관성, 독립성, 견고성. 원자성은 트랜잭션의 작업이 모두 완료되거나 아예 실패가 되는 성질을 말한다. 일관성은 작업 완료 후 모든 데이터의 정합성이 맞아야 한다.  독립성은 다수의 트랜잭션에서 작업을 실행할 경우 순차적으로 처리가 되어야 한다. 견고성은 트랜잭션이 커밋되고 나면 어떤 비상사태에서도 데이터가 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg4NzU5NjUzOSwxNTM2NTE4NzksLTMwNT
g5MTU5MywxODI0MjEwNDk2LC0xMzQyNzg1NTcsLTEzNDUxNzEy
MzIsMTgxMzk0MTgwMSw5OTk1NTI5NCwxNjYwMDMzODEwLC01NT
M1NDEyNzYsLTE2NDQzNzk0MDgsMTQ1MjMzNzY5MCw3MzY5NjMw
MTIsMjA1NzY4ODcxNywtNjUzMDU1Mjk4LC0xNDI5MDk0MjYzLC
0yNzE2ODYyMzksLTE1MTk4NzYwNzEsODQzNjk1MjMyXX0=
-->