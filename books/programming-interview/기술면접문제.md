...
> HTTP2는 성능과 속도 모두 뛰어나다. 요청과 응답시 멀티플렉싱을 통하여 레이턴시를 줄이고(MultiPlexing), HTTP header필드를 압축하여 프로토콜 오버헤드를 줄이며(Header Compression), 요청 우선순위(Prioritization)와 서버푸시기능(Server Push)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA2MzIwODg2NiwtNTUzNTQxMjc2LC0xNj
Q0Mzc5NDA4LDE0NTIzMzc2OTAsNzM2OTYzMDEyLDIwNTc2ODg3
MTcsLTY1MzA1NTI5OCwtMTQyOTA5NDI2MywtMjcxNjg2MjM5LC
0xNTE5ODc2MDcxLDg0MzY5NTIzMl19
-->