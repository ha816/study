...
>**URL?**
>url(Uniform Resource Locator)이다. 클라이언트에 공개하는 리소스의 위치자를 말한다. 리소스가 어디 있는지를 알려주기 위한 규약이다. 예를들어 https://www.google.co.kr/search?q=uri가 있다고 하자. 여기서 URL은 https://www.google.co.kr/search까지이고, 내가 원하는 정보를 얻기위해서는 q=uri라는 식별자가 필요하므로, https://www.google.co.kr/search?q=uri 이 주소는 URI이지만 URL은 아니다.
>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTk4MDE1MzUyLC02NTMwNTUyOTgsLTE0Mj
kwOTQyNjMsLTI3MTY4NjIzOSwtMTUxOTg3NjA3MSw4NDM2OTUy
MzJdfQ==
-->