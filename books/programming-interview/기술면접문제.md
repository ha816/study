...
>**URL?**
>url(Uniform Resource Locator)이다. 클라이언트에 공개하는 리소스의 위치자를 말한다. URI(동물)  가 좀더 상위 개념이라서  URL(강아지),  URN(다람쥐)  등의 하위 개념을 포함한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDA0NTE1MDM3LC0yNzE2ODYyMzksLTE1MT
k4NzYwNzEsODQzNjk1MjMyXX0=
-->