...
>Statement는 사용하는 쿼리문 자체를 DB서버에 보낸다. 때문에 SQL Injection에 취약하며 사용하는 쿼리가 비슷하더라도 성능 이점을 얻을 수 없다. PreparedStatement는 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjEyMzE4MTczLC0xNjc2MzMxNjkwLDE3OD
