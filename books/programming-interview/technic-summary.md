...
>HashMap은 Hash를 이용하여 Key-Value 쌍을 가지는 데이터 구조이다. HashMap은 주어진 키에 대응하는 값을 찾는데 상수시간만에 찾는다. HashMap은 성능은 Hash함수가 달려있는데, 극단적으로 Hash함수가 같은 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY5NDA4NTM3NSwtMTc1NjgwNzU2Miw3Mj
