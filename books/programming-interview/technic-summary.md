...
>애플리케이션 컨텍스트의 생성시기가 다르다. 루트 웹애플리케이션 컨텍스트는 스프링 동작시 생성된다. 서블릿 웹 애플리케이션은 지연 생성으로 실제 요청이 들어올때 생성된다. 참고로 루트 웹애플리케이션 컨텍스트에는 모든 서블릿 애플리케이션에서 사용하면 좋을 빈들이 올라간다. 대표적으로는 DataSource가 있다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk4NTM1NjAzNCwxMDkyMTQ2MzcyLC0xOT
M4MTQyOTAyLC0yMDM5NDgyMjg4LC0xMTc5OTU4NTY4LC0xOTY0
ODQxMjgwLC0xODAwNzM3OTczLDE0MDU0NTQ1NDcsLTQwODg5ND
E5NCwtMTAxMTI4ODM3OSwtMjA1Nzg0OTUzMiw5MTY1NzI3Mzks
LTI1OTQ1NDIxMiwtMjA4NjA0NzAwOCwxNDEwNDcxMTQzLC0xMj
QwNDQ1NzQ3LC0zMTI3NDM3MzEsLTUzMDAwMTc1NCw3MjIwMzE2
MTYsLTgzNzk1MDI2MF19
-->