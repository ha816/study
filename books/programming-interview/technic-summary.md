...
> SynchronizedMap과 ConcurrentHashMap 모두 Thread-Safe를 보장한다. SynchronizedMap은 데이터 수정이 일어날때 완전히 모든 데이터에 락을 걸고, 다른 쓰레드들은 락이 풀렸을 경우에만 접근이 가능하다. ConcurrentHashMap은 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk2NzQxNjIxNiwxODI2ODcyNDQ5LDc0Nj
