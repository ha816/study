...
>서블릿은 Core J2EE Patterns에서 정의한 Front Controller패턴을 따른다. 웹 애플리케이션은 요청처리(Request Handling)을 위한 중앙 집중식 접속점이 필요하다. 그렇지 않으면 요청을 처리하는 제어
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NjA0MjI0MjYsLTE0MTk2MjM1MDIsLT
