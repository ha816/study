...
>Java에서 abstract 클래스와 interface클래스는 모두 객체가 될 수 없다. abstract 키워드가 붙은 클래스는 실제 구현된 메서드와 구현되지 않은 추상화 메서드를 모두 가질 수 있다. a
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMDYyMTAzOTcsLTQxMzA5MDA5MiwtMT
