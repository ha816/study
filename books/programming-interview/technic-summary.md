...
>예외는 크게 RuntimeException과 Unche Exception으로 나뉜다. RuntimeException은 런타임시 발생하는 예외로 대표적으로는 NullPoint, ArrayOutofBound 등이 있다. 명시적 예외는 코드 상에 예외처리를 위한 코드를 작성해야 하며, 대표적으로 IO Excetpion이 있다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQzNTUzMzI2MCwtMTYwNTczOTk2MSw5MD
