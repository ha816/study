...
>HashMap은 Hash를 이용하여 Key-Value 쌍을 가지는 데이터 구조이다. HashMap은 주어진 키에 대응하는 값을 찾는데 상수시간만에 찾는다. HashMap은 성능은 Hash함수에 달려있는데, 극단적으로 Hash함수가 같은 값만을 반환한다고 가정하면, 항상 Hash Collision이 발생한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM5MDIyNzkwMywtMTc1NjgwNzU2Miw3Mj
cwOTIwNTQsMjA5NTI5NjU2LC0xNjA1NzM5OTYxLDkwMDkxMDY4
MCwxNDU5MzM5MjU5LDEyNTExNjAzMjksLTgyNDY3OTAxMCwtOT
