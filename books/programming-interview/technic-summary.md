...
>final 키워드는 변수, 클래스, 메서드에 붙일 수 있다. 원시타입변수에 붙이면, 값을 바꿀 수 없고, 참조변수에 붙이면, 주소값을 변경할 수 없다. 클래스나 메서드에 붙이면, 해당 클래스나 메서드를 상속받거나 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM5MjM0MTUzMiwxNzU2MDk5ODMsLTE4Mj
