...
>static 키워드는? 
>static 키워드는 변수, 메서드, 클래스에 붙일 수 있다. Static이 붙은 변수, 메서드는 해당 클래스내에서 공유되는 자원으로 JVM 동작시 Method Area에서 하나만 존재한다. 일반 클래스에는 static 키워드를 붙일 수 없고, 내부 클래스(
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjYwNDg1NTE0LDEyMjUzNDkxODIsMTc1Nj
A5OTgzLC0xODIzNDE0NTgzLDk1NTAyNTMyNiw4OTYzMzI4MDks
LTE2MDUxNDA3NzAsMTQzNDc0OTU5OF19
-->