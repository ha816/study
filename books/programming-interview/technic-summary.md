...
>static 키워드는? 
>static 키워드는 변수, 메서드, 클래스에 붙일 수 있다. Static이 붙은 변수, 메서드는 해당 클래스내에서 하나로 공유되는 자원으로 JVM Method Area에 올라갈때 자원이 이미 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NDY4NzQ5NzUsMTIyNTM0OTE4MiwxNz
