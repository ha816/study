...
>Generic이란 타입을 매개변수로 받는 것을 말한다. 예를 들어 List는 담을 원소의 타입을 제네릭을 이용해서 정할 수 있다. 제네릭은 reified 하다고 하는데 이는 컴파일 단계에서는 존재하지만 실제 런타임 코드에는 없는것을 말한다.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc3OTk2NTU3MCwtOTE3NDUxNzY4LC05Mj
