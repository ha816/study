...
>static 키워드는? 
>static 키워드는 변수, 메서드, 클래스에 붙일 수 있다. Static이 붙은 변수, 메서드, 클래스는 클래스내에서 모두 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzA3MDY0MjY4LDE3NTYwOTk4MywtMTgyMz
QxNDU4Myw5NTUwMjUzMjYsODk2MzMyODA5LC0xNjA1MTQwNzcw
LDE0MzQ3NDk1OThdfQ==
-->