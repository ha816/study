...
저는 3년간 TMON의 배송파트에서 개발 경력을 쌓았습니다. 배송파트에서는 배송 도메인 뿐만 아니라 취소, 환불 도메인도 함께 하고 있고 두 가지 도메인에서 서비스 개발 및 유지보수가 저의 역할이었습니다. 그 과정에서 REST API, 

업무 시 주로 사용한 기술로는 java 기반의 Spring(4.3.3), DB에는 MySQL, 배치성 작업에는 Spring Batch를 사용하였습니다. 이런 기술들을 REST API 개발, DB 스키마 설계 및 생성

마지막으로 유저뷰(모바일 웹), 어드민 페이지도 만들었습니다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUwNDc4Nzc3LC0xOTk0Njg1NDUzLC01OD
QxMzI4LC05NzA2NjA3NV19
-->