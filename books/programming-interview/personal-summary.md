...
저는 3년간 TMON의 배송파트에서 개발 경력을 쌓았습니다. 배송파트에서는 배송 도메인 뿐만 아니라 취소, 환불 도메인도 함께 서비스 개발 및 유지보수가 주 도메인이었습니다. DB 설계 및 생성, API 및 Batch 개발, 마지막으로 유저뷰(모바일 웹), 어드민 페이지도 만들었습니다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgyNTgzODgzNiwtNTg0MTMyOCwtOTcwNj
YwNzVdfQ==
-->