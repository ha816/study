...
업무 시 주로 사용한 기술로는 java 기반의 Spring(4.3.3), DB에는 MySQL, 배치성 작업에는 Spring Batch를 사용하였습니다. DB 설계 및 생성, API 및 Batch 개발, 마지막으로 유저뷰(모바일 웹), 어드민 페이지도 만들었습니다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5OTQ2ODU0NTMsLTU4NDEzMjgsLTk3MD
Y2MDc1XX0=
-->