...
저는 3년간 TMON의 배송파트에서 개발 경력을 쌓았습니다. 배송파트에서는 배송 도메인 뿐만 아니라 취소, 환불 도메인도 함께 하고 있고 두 가지 도메인에서 서비스 개발 및 유지보수가 저의 역할이었습니다. 그 과정에서 REST API, DB 설계 및 생성, 배치 개발 등을 했고 간간히 유저뷰(모바일 웹), 어드민 페이지도 만들었습니다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMjE3NzAzMzcsLTE5OTQ2ODU0NTMsLT
U4NDEzMjgsLTk3MDY2MDc1XX0=
-->