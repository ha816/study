...
업무 시 주로 사용한 기술로는 java 기반의 Spring(4.3.3), DB에는 MySQL, 배치성 작업에는 Spring Batch를 사용하였습니다. 이런 기술들을 REST API 개발, DB 스키마 설계 및, 사용해서 REST API 마지막으로 유저뷰(모바일 웹), 어드민 페이지도 만들었습니다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMzMzg2NjYyMywtMTk5NDY4NTQ1MywtNT
g0MTMyOCwtOTcwNjYwNzVdfQ==
-->