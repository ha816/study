...
* 온라인 거래 처리용 데이터베이스온라인 트랜잭션 처리(OnLine Transaction Processing; OLTP) 
	* 
		* 온라인 시스템 환경에서는 데이터베이스 관리 시스템로 질의가 웹 요청과 응답 시간의 차이가 밀리초 단위 사이로 이루어져야 한다.
* 확장형으로 설계된 DB
	* Neo4j는 OLTP 작업을 처리하기 우
* 선언적 질의어 - 사이퍼
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzI1Mjg2OTk5LDgzNzA0MjExNCwtNjEwOD
U3MDg0LC0xNDY0MDY0ODcyXX0=
-->