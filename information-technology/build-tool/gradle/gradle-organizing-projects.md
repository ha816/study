...
Gradle에선 language에 따라 디렉토리를 나누고 대응하는 소스를 해당 디렉토리에 저장하는 것을 추천합니다. 왜냐하면 빌드가 더 잘 동작할 뿐만 아니라 기본 설정이기 때문에 사용자와 빌드가 모두가 편하기 때문입니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTc3NTgxODI0LDE3OTY0NzkzNjAsMTY0Nj
