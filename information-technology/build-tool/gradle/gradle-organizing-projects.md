...
buildscript 블럭은 기본적으로, Gradle 스스로의 빌드를 위한 변수, repositories, dependencies등을 설정하는데 사용합니다.

여기서 Gradle 자신이 아닌 다른 모듈에 대한 의존성은 buildscript 블럭에 적으면 안됩니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgyOTU1MTU0NiwxNzk2NDc5MzYwLDE2ND
