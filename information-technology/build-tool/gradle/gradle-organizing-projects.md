...
또 다른 방법으로 source Set을 활용하는 방법을 봅시다. 한 프로젝트에서 여러 종류의 테스트를 정의하고 실행하는 것은 자주 있는 일입니다. (unit tests, integration tests, functional test과 같은)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzcwMTIxNDE5LDE0NzQ3Njc2NzIsLTEyOD
