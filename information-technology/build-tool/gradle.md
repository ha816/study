...
Apache Maven Terminology(용어)에 빗대어 비교해보자면, Gradle의 build phase는 Maven의 phases와는 다릅니다. 우리에게 익숙한 
[Maven Build Phases](https://maven.apache.org/guides/introduction/introduction-to-the-lifecycle.html)는 전체 빌드 과정을 단순히 단계별로 나누어 이해하기 위 사용합니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU5MjczNTUzOCwtMTk1NjAzNDEzMCwtMT
