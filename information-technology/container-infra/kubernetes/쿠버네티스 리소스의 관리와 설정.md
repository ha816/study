...
물론 서비스, 레플리카셋을 비롯한 여러 리소스들도 각 네임스페이스에 별도로 존재합니다. 네임스페이스는 쿠버네티스의 리소스를 논리적으로 묶을 수 있는 가상 클러스터처럼 사용할 수 있습니다. 쿠버네티스 클러스터를 여러명이 동시에 사용해야 한다면 사용자마다 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NTAxMDQxOTUsLTEzOTQ5NDY3NDEsLT
E4NjcyMDEwMDMsMzQ3Mjg1NDUzLDM1MTgxNDE4Nyw5MzcwNzA2
OSw0MTEwMTc2NjFdfQ==
-->