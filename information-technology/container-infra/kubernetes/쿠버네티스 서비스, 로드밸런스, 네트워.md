...
쿠버네티스의 서비스는 Pod와 같은 쿠버네티스 인스턴스지만 비슷한 REST 오브젝트 처럼 취급되기도 합니다. 다른 REST 오브젝트와 마찬가지로, 서비스 정의를 API 서버에  `POST`하여 새 인스턴스를 생성할 수 있습니다. 서비스 오브젝트의 이름은 유효한  [DNS 서브도메인 이름](https://kubernetes.io/ko/docs/concepts/overview/working-with-objects/names/#dns-%EC%84%9C%EB%B8%8C%EB%8F%84%EB%A9%94%EC%9D%B8-%EC%9D%B4%EB%A6%84)이어야 한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjYyODg5NTg3LC0xNjI5NTc3OCwtMTUwOT
