...
**쿠버네티스에서 서비스**는 **하나의 논리적인 파드 셋과 그 파드들에 접근할 수 있는 정책을 정의하는 추상적 개념**입니다. 서비스는 종속적인 파드들 사이를 느슨하게 결합되도록 해줍니다. 서비스는 모든 쿠버네티스 오브젝트들과 같이 YAML 이용하여 정의합니다. 서비스가 대상으로 하는 파드 셋은 보통  LabelSelector_에 의해 결정됩니다. 
...
Pod는 서로 독립적인 IP주소를 가집니다. 그리고 서비스는 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTc2MjE2NzEwLC0xNTA5NTY4ODksLTgyNz
k3MDk0MiwxOTM5Njk4Njk0LC0xMjMxNTY1NDI2LDMxNzcwMTcz
Myw3MzA5OTgxMTZdfQ==
-->