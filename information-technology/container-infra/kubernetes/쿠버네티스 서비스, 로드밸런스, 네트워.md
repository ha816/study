...
쿠버네티스  [파드](https://kubernetes.io/ko/docs/concepts/workloads/pods/pod-overview/)는 수명이 있다. 파드는 생성되고, 소멸된 후 부활하지 않는다. 만약 앱을 실행하기 위해  [디플로이먼트](https://kubernetes.io/ko/docs/concepts/workloads/controllers/deployment/)를 사용한다면, 동적으로 파드를 생성하고 제거할 수 있다.
...
## 서비스 리소스[](https://kubernetes.io/ko/docs/concepts/services-networking/service/#service-resource)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE3Mzk4MDQ3Nyw3MzA5OTgxMTZdfQ==
-->