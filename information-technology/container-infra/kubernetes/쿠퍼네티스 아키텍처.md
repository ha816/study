...
흐름을 보면 **각 모듈은 서로 통신하지 않고 오직 API Server**와 통신하는 것을 알 수 있습니다. API Server를 통해 etcd에 저장된 상태를  현재 상태와 원하는 상태가 다르면 필요한 작업을 수행합니다. 각 모듈이 하는 일을 보면 다음과 같습니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk1NjUxNTU1OSw2ODAzMjI0MjcsMTU0Nj
