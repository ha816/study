...
spec:
  ...
  template:
    ...
    - name: nginx
      ...
      - containerPort: 80      
```
위의 YAML은 사실 레플리카셋의 YAML파일과 비교하여 큰 변경점이 없습니다. 디플로이먼트를 생성하면 my
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU4ODk3MDk2MywtODcxOTEyMTcyLC01Nz
Q4NTExNCwyMTE0NjE0ODA4LC01Mjg3NTg0NTgsLTEzNDQyMDQ5
NTUsMTUzNDk0MTQyLC01NDc3OTQxODQsMTgyMzc1OTQ4OCwtNj
