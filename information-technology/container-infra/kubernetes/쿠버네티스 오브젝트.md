...
디플로이먼트로 오브젝트를 생성한 뒤에 
디플로이먼트 YAML을 작성하고 아래 명령어를 실행해봅시다.
```yaml
kubectl apply -f deployment-nginx.yaml --record
```

여기서는 특수하게 --record라는 옵션을 추가했습니다. 레플리카셋 목록을 출력해 보면 동일한 이름의 두개의 레플리카셋이 생성됩니다. 디플로이먼트로 새로운 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY5MTY1ODA4MCwtMTk2Mjk5MzIsLTg3MT
