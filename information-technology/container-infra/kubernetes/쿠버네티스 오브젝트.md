...
하나의 **포드는 개념적으로 하나의 완전한 애플리케이션입니다.** 만약 한 애플리케이션이 실행되기 위해서 부가적인 기능이 필요하다고 가정해보면, 이런 경우 포드의 메인 컨테이너를 본연의 애프
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg5MzA4OTIyLC05NzM4MjcyOTIsNDk4OT
QwMDg0XX0=
-->