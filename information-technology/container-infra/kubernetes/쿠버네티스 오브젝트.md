...
예를 들어, 레플리카 셋은 **spec.selector.matchLabel**에 정의된 라벨을 통해서 생성해야할 포드를 찾습니다. 앞서 예제에서는 `app: my-nginx-pods-label` 라벨을 가지는 포드의 개수가 replicas 항목에 정의된 숫자인 3개 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NTQzMTMxNjYsLTEzNDQyMDQ5NTUsMT
UzNDk0MTQyLC01NDc3OTQxODQsMTgyMzc1OTQ4OCwtNjgwNTQ2
Nzk4LDU1Mzg5MDAzNSwyMDIxOTYzNzE3LC05NzM4MjcyOTIsND
k4OTQwMDg0XX0=
-->