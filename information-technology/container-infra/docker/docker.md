...
도커 이미지는 컨테이너를 생성할때 필요한 요소입니다. 이미지는 여러 계층으로 된 바이너리 파일로 존재하고, 컨테이너를 생성하고 실행할때 읽기 전용으로 사용됩니다. 이미지는 도커 명령어로 내려 받을 수 있으므로 별도로 설치할 필요는 없습니다. 
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NjI1Mjg2NzEsOTgwNTQzMzEzLC05MD
U4ODMwNjRdfQ==
-->