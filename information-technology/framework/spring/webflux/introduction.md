...
여러 장점이 있지만 webflux의 사용은 사실 필수가 아니라고도 합니다. (심지어 Spring에서)또 기존 servelet기반의 코드를 webflux로 머지하는 과정이 쉽지 않다. 따라서 무리하여 	webflux로 이관하는 것은 좋지 않으며, 새로운 서비스에 접목하는 것이 좋아 보인다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMjU4NjYwMjMsLTE2NzUwOTc0MDIsMj
