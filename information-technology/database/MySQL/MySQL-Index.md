...
예를 들어 하나의 테이블에 country와 city라는 컬럼을 가지고 있다고 하자. 해당 테이블에 전체 레코드 갯수는 1만건이고, country 칼럼으로만 인덱스가 생성된 상태에서 country 컬럼의 유니크한 값의 갯수가 10개 또는 1,000개인 경우를 나누어 생각해보자.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY3MTQyMzc1OSwxODQ4Njk0MTQ2LDk3OT
