...
여기서 언급한 내용은 인덱스 키 값을 가능한 크기가 작 만들면 좋다는 것을 강조하는 내용이고 아무리 대용량의 데이터 베이스라도 B-Tree깊이가 4~5이상까지 깊어지는 경우는 별로 없다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU4ODQ5MDc2OCw5NzkyOTAzNTAsLTkyNj
