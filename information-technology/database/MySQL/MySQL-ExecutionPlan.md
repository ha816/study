...
총 12가지 접근 방법 중에서 ALL을 제외한 나머지는 모두 인덱스를 사용한 접근 방식이다. 하나의 단위 SELECT 쿼리는 위의 접근 방법 중에서 단 하나만 사용할 수 있다. 한 단위 SELECT에는 다수의 테이블 조인이 일어날 수 있는데 이 다수 테이블에서 필요한 정보를 인덱스를 사용하여 가져오도록 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTQxMTM2MjIyLDEzNDg4NDEyMjEsLTE3Nj
