...
인덱스를 사용하지 않고 테이블 전체를 읽어 작업을 처리한다. 풀 테이블 스캔은 아래와 같은 조건에서 주로 풀테이블 스캔을 선택ㅎ
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTExNTUzMDY5NywtMTgwODk0MTE2OSwxOD
QxOTU3NjExLDExMDk0NTkyNDAsLTYxNDM3NTk4OCwtMjgyNDEw
MzVdfQ==
-->