...
트랜잭션의 격리 수준이란 **동시에 여러 트랜잭션이 처리될 때, 특정 트랜잭션이 다른 트랜잭션에서 변경하거나 조회하는 데이터를 볼 수 있도록 허용할지 말지를 결정**하는 것이다. 격리 수준은 크게 "READ UNCOMMITED", "READ COMMI"
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNTAwMjM4MzAsNjMzNTY1ODAzLDYyMz
