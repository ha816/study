...
격리 수준에는 "READ UNCOMMITED", "READ COMMITED", "REPEATABLE READ", "SERIALIZABLE"가 있다. 언급한 순서대로 트랜잭션간의 고립(격리)정도가 높아지며, 동시성은 떨어지는 것이 일반적이다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MjgwMTY3NDMsMjkzMjg5MTkxLDkzNT
