...
변경작업이 많은 서버에서는 리도 로그 기록작업이 큰 문제가 되는데, 이 부분을 보완하기 위해 트랜잭션을 보장하는 수준에서 버퍼링을 하기 된다. 그리고 리두 로그 버퍼링에 사용되는 공간이 로그 버퍼이다. 
...
# MySQL 로그 파일
<!--stackedit_data:
eyJoaXN0b3J5IjpbODM1NTc0OTEzLC0xNjg0NTE1NjEzLC0zND
Q1NDU2MDYsLTEyNjczNzk5MzUsNzE2OTAzNCwtNjU2OTQ3NjI5
LC0xMzUyODM0ODIyLC0xNjc0OTgyMDU0XX0=
-->