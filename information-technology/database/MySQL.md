...
Replication은 2대 이상의 MySQL 서버가 동일한 데이터를 가지도록 실시간으로 동기화하는 기술이다.  일반적으로 마스터 서버는 반드시 1개이며, 슬래이브는 1개 이상으로 구성한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk3NjE2OTkzMSwxMzM4NTUzNjUyLC0xOD
