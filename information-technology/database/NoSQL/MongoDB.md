...
일반적으로, 프로그래밍 언어의 각 드라이버는 BSON으로 직렬화나 역직렬화를 할때 언어의 문자열 포맷을 UTF-8로 변경합니다. 때문에 대부분의 BSON 문자열의 각 문자들을 저장하는게 쉽습니다. 게다가 MongoDB는 $regex 쿼리로 regex 문자
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NDgzODc1MTEsLTE4MzYzMjM3MzIsLT
