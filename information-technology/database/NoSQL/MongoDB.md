...
MongoDB는 내부적으로 또 네트워크 상으로  BSON 형태로 데이터를 저장합니다. JSON으로 표현 가능한 어떤것도 MongoDB로 자연스럽게 저장 가능하고, 또 JSON으로 찾을 수 있습니다.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NzIxNTkxMzksLTEyNDEyMDIwNzAsMT
