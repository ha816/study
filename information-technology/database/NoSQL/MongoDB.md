...
BSON 포맷이 little-endian이기 때문에 나머지 bits를 먼저 저장하는 반면에, mongo daemon 객체는 항상 `time_t` 값을 비교합니다. endian 형태를 생각치 않고, 모든 플랫폼에 대해서  `ordianl` 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNzc5MDgxNTEsLTEzMzc0OTM1OTAsLT
