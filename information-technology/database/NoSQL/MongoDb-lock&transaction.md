...
WT가 SNAPSHOT 수준의 격리 수준을 지원한다고 해도 결국 MongoDB가 스토리지 엔진을 제어하기 때문에 MongoDB 서버 처리에 의존적일 수 밖에 없습니다. 그리고 MongoDB는 기본적으로 단일 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MTE0MDQ2NDYsNjIyODM1MTk4LC02OT
