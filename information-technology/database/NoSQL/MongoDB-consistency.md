...
causally consistent sessions으로, MongoDB는 그들의 causal 관계십에 기반한 순서대로 causal 연산을 수행합니다. 그리고 클라이언트는 casual 관계의  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ1MTc3OTkwNCwtMTk1NjgyNjU5MSwxNj
k3NjMyMzQ1LC0xNzQwNzM4NDQwXX0=
-->