...
Proxy는 우리말로 대리자, 대변인 이라는 뜻이다. 원래 작업을 해야할 객체가 아닌 Proxy가 대신해서 작업을 수행한다. 이 과정에서 원래 기능을 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM1MDU3NDM4NywtMTI3NjA0NDExOCwxNT
g5MjUwMCwxMTM2ODU0MzU0XX0=
-->