...
Proxy는 우리말로 대리자, 대변인 이라는 뜻이다. 원래 작업을 해야할 객체가 아닌 Proxy가 대신해서 작업을 수행한다. 이 과정에서 원래 기능을 대리자는 실제 서비스의 메서드 호출 전후에도 별도의 로직을 수행할 수도 있다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjE3NTg5NjM5LDExMjc5NzE1NSwtMTI3Nj
A0NDExOCwxNTg5MjUwMCwxMTM2ODU0MzU0XX0=
-->