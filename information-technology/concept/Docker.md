...
도커 데몬은 호스트 장비 위에 설치되는 서버 측 컴포넌트 도커 컨테이너를 만들고, 실행하고 배포하는 역할을 담당한다. 또한 도커 클라이언트를 위한 API를 외부에 노출하여 도커 클라이언트가 도커 데몬과 상호작용할 수 있게 한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MTc3NjQ3OTUsLTExOTUyNDM3ODksLT
