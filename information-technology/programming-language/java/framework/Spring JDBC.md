...
고맙게도 스프링은 이런 기본적인 사항들을 관리할 수 있는 유틸리티를 제공한다. **JdbcUtils.close*** 로 시작하는 메서드들이다. JdbcUtils는 순수한 JDBC 코드를 개선하는데 사용하는 클래스다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ2NDI5NDg5NCwtNjY3MzUzMjUsOTkyND
Q5OTUwXX0=
-->