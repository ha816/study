...
세터 메서드를 사용해서 필요한 의존성이 주입된 객체를 만드는 방법. @Bean 애너테이션이 붙은 Bean 생성 메서드로 필요한 객체를 만들고, 세터메서드로 의존 주입을 통한 객체를 반환한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODk5ODUzOTAxLDIwNjEwMzE5MDIsMTkxOD
