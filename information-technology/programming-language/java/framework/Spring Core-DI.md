...
스프링 코어에서 가장 중요한 것은 **DI(Dependency Injection)**이다. 
일반적으로 하나의 애플리케이션을 동작하기 위해 여러개의 컴포넌트를 통합해서 사용한다. 이때 의존성 주입이라는 접근방식이 큰 힘을 발휘한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NzQyNzQwODddfQ==
-->