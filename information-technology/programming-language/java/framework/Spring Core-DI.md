...
DI는 IoC(Inversion of Controll)과 혼용되어 사용되는데 IoC는 인스턴스를 제어하는 주도권이 역전된다는 의미이다. 컴포넌트를 구성하는 인스턴스의 생성과 의존관계를 해당 클래스가 아닌 DI 컨테이너가 대신해주기 때문이다. 즉 DI를 하다보니 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDgyNDUyMjc2LC0xNzIwNDI2MjMwXX0=
-->