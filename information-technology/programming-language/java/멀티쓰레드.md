...
동시성 프레임워크(Executor Framework)는 자바 4에서 도입되었고 

동시성을 위한 클래스들을 제공했는데 자바의 스레드 모델을 이용하는데 큰 도움을 주었다. Executor 프레임워크는 다음과 같은 특징을 지닌다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg3Mjk1MDQ5Niw1NTk5MjkxMTMsMTMzOD
k1MzQ0MF19
-->