...
Task는 고전적인 Runnable과 Callable

Task를 가진 Task Queue에서는 ThreadPool에 있는 쓰레드들이 각기 본인의 Task를 가지고 작업을 처리하기 때문에,
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDEzMDYwNTE5LDE0ODY2MTMyNSwtMzY2Mz
