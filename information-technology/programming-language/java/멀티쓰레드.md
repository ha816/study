...
스레드를 생성하는 과정에서는 메모리의 자원을 많이 소비하게 되는데, Executor 인터페이스는 스레드를 미리 생성하고, 그 수를 제한하며, 사용된 스레드를 재사용함으로써 효율을 높인다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODg5Njk2NDE5LC01ODMyNzA5MTAsMTQ4Nj
YxMzI1LC0zNjYzMzA3MDMsLTE0NTY4Mzc5OTQsLTg1OTk2MTIz
MCw1NTk5MjkxMTMsMTMzODk1MzQ0MF19
-->