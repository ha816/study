...
```
Thread t1 = new ExtendsThread(); // Thread 확장한 객체
t1.start();
```

```
Runnable r1 = new ImplementsThread(); // R
Thread t1 = new Thread(); // Thread 확장한 객체
t1.start();
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNTA0ODM0NjAsLTM2MDQ0NDkyMSwtOT
IzMzgwMTYyLDExMzYxNTMzMzMsLTQ2MjkzNjgyMyw3MTQzMjg2
MSwtMTE1NTU5NDA1NywtMTEzMDI4NjMyNCwxMDkxMTcxMjgzLD
EwODI3ODQyODUsLTU4MzI3MDkxMCwxNDg2NjEzMjUsLTM2NjMz
MDcwMywtMTQ1NjgzNzk5NCwtODU5OTYxMjMwLDU1OTkyOTExMy
wxMzM4OTUzNDQwXX0=
-->