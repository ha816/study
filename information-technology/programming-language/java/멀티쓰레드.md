...
Customer는 Application에서 ExecutorService에 Task 작업 실행을 요청한다. submit을 하게 되면, ExecutorService 내부에서 해당 Task를 내부적으로 스케쥴링 하면서 적절하게 일을 처리한다. 구체적으로는 TaskQueue에서 해당 Task를 관리하게 된다. Task Queue에 들어온 task는 Thread Pool에서 하나의 스레드가 맡아 처리한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzE0MzI4NjEsLTExNTU1OTQwNTcsLTExMz
AyODYzMjQsMTA5MTE3MTI4MywxMDgyNzg0Mjg1LC01ODMyNzA5
MTAsMTQ4NjYxMzI1LC0zNjYzMzA3MDMsLTE0NTY4Mzc5OTQsLT
g1OTk2MTIzMCw1NTk5MjkxMTMsMTMzODk1MzQ0MF19
-->