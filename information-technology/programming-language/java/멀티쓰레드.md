...
Customer는 Application에서 해당 ExecutorService를 사용하는 요청한다submit을 하게 되면, ExecutorService 내부에서 해당 작업을 내부적으로 스케쥴링 하면서 적절하게 일을 처리한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2ODk3NjgxMywtMTE1NTU5NDA1NywtMT
