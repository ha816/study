...
메소드 호출시 파라미터를 전달, 필요로 하는 변수 저장, 상수에 대한 참조. 스택 변수의 생애주기는 스코프에 영향을 받는데 특정 스코프가 종료되면 스코프 안에 선언된 변수들은 스택에서 제거된다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA1NTY3NzE5MCwxMjYyMzgxMzQsLTE1Nz
