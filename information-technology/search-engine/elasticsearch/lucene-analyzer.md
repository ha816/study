...
동의어를 모아둔 파일을 일컬어 동의어 사전이라 부른다. 엘라스틱 서치에서 가장 까다로운 부분 중 하나가 바로 동의어 사전을 관리하는 것이다. 검색엔진에서 다루는 데이터가 많아지면 많아질 수록 동의어 수도 늘어난다. 특정 분야별로 파일도 늘어날 것이고  그 안에 변환 규칙도 많아질것이다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk2NTM1NjI1MiwtOTEwOTc4NzM2LC04MD
