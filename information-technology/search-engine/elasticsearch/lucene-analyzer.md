...
엘라스틱서치에서 제공하는 토큰 필터중 **Synonym 필터**를 사용하면 동의어 처리 가능해진다. 동의어 처리란 **원문 단어의 동의어나 유의어에 해당하는 단어를 함께 색인하여 원문에 특정 단어가 없더라도 검색이 가능해지게 하는 기술이다.**  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgwMDY2MzE0MSw5MzE3MDk3ODcsLTEwNj
