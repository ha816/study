...
검색 시스템은 엄청난 양의 문서를 다루어야 하고, 개념상 이 문서의 개 하나의 하드웨어에서 제공하는 리소스의 물리적인 한계를 넘기 위해 도입한 개념이 바로 샤드이다. 샤드를 이용하면 문서를 분산 저장할때 손쉽게 수평확장이 가능해진다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY4OTM3ODc3NCwtMjA2OTY4MDQ1MV19
-->