...
수평적으로 분산된 시스템을 운영할땐 언제든 장애가 나타날 수 있다. 네트워크의 특성상 특정 노드가 오프라인으로 변경될 경우, 페일오버(Failover) 메커니즘을 적극적으로 활용하는 것이 좋은데 엘라스틱서치에서는 바로 레플리카를 이용한 페일오버 메커니즘을 제공하고 있고 이를 이용해 안정적인 클러스터 운영을 보장한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMjQyNTc3NTgsLTIwNjk2ODA0NTFdfQ
==
-->