...
루씬의 Commit이 정상적으로 수행되면 Translog에 적재되었던 변경사항 기록 중에 Commit이 정상적으로 일어난 시점 전까지 기록 내역이 Translog 파일에서 삭제된다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMzNTk3MDUxNiwtMTE3NTIyNzYzMCwtND
