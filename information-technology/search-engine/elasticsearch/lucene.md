...
Merge는 작업이 완료되면 반드시 Commit이 동반되어야 한다. Commit은 매우 비용이 비싼 작업이기 때문에 정책적으로 적절한 주기를 설정하는 것이 매우 중요하다. 전체적인 성능 향상을 위해 루씬은 자동 주기로 세그먼트의 병합 작업을 수행한다. 작업 주기는 최적의 성능을 낼수있도록 설정되며 백그라운드로 수행된다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTA1NzIxNzA5LDIwMjQ3MTE5ODIsLTU3MT
