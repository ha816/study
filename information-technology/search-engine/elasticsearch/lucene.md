...
샤드는 루씬 인덱스와 같지 않다. 샤드 엘라스틱서치에서 추가한 다양한 기능을 포함하고 있기 때문이다. 하지만 주요 기능은 루씬 인덱스에 있는 기능이다. 정리하자면, **엘라스틱서치에서 하나의 샤드는 자체적으로 데이터를 색인하고 검색할 수 있는 가장 작은 단위의 단일 검색엔진**이라고도 할 수 있다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjAwODMxNzg1LC0xODg3ODIxNDE2LDcxNz
