...
일단 Flush 처리에 의해 세그먼트가 생성되면 커널 시스템 캐시에서 세그먼트가 캐시되어 읽기가 가능해진다. 커널 시스템 캐시가 생성되면 루씬의 ReOpen함수를 활용하여 IndexSearcher에서도 해당 캐시를 읽을 수 있는 상태가 된다. 사실 ReOpen 함수는 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcxNzk3MjE4MSwtNTcxOTc5Mzg1LDEyMD
