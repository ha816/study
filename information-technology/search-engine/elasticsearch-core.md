...
엘라스틱서치가 기본적으로 분산 시스템을 지향하다보니 생소한 용어가 많다. 용어가 무엇인지 잘 파악하면 전체 아키텍처를 이해하는데 많은 도움이 될것이다. 엘라스틱 서치를 구성하는 주요 구성요소로 어떤 것이 있는지 알아보자.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEwNzk3OTgwN119
-->