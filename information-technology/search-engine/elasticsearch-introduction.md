...
* 완벽한 실시간 검색이 아니다. 일반적으로 색인된 데이터는 통상적으로 1초 뒤에나 검색이 가능하다. 색인된 데이터는 내부적으로 커밋과 플러시 같은 복잡한 과정을 거치기 때문에 실시간이 아니다. 엄밀히 말하면 실시간(Near Realtime)이라 할 수 있다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEyNDEwMDUyMywyMDQ5Njk2NjMyXX0=
-->