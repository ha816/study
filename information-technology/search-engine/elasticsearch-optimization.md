...
특별히 정해진 공식적인 크기는 없지만 다양한 사례를 통해 샤드 1개가 물리적으로 50GB를 넘지 않도록 권장하고 있다. 인덱스에 저장되는 전체 데이터의 크기에 따라 샤드의 개수를 몇개로 설정하면 좋을지 간단한 예제로 살펴보자. 

### 인덱스 전체 데이터가 400GB 이상인 경우
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NzQ0Mzg2OTcsLTEyNzc3MzMxMTUsOD
