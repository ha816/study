...
Compressed OOP는 포인터 공간의 낭비를 줄이고 좀 더 빠른 연산을 위해 포인터를 압축해서 표현하는 일종의 트릭이다. 이 트랙의 핵심원리는 포인터가 객체의 정확한 메모리 주소를 가리키게 하는것이 아니라 상대적
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2ODI4Mzc0MDMsLTE1ODAyMDQ0NjcsMT
