...
주어진 숫자 n이하의 숫자 중에서 소수를 구하는 알고리즘이다. 간단한 방법은 2 ~ n까지의 모든 숫자를 소수인지 판별하여 계산해보는 것이다. 일일이 모든 숫자를 소수 판별하는 대신에, 효과적으로 소수를 구하는 방법이 바로 에라토스테네스의 체이다. 여기서 이용하는 성질은 소수인 숫자가 있으면, 그 숫자의 배수는 모두 합성수라는 성질이다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEzMzU2MjM1LC0xMDY4OTQ3NzIzLC0xNz
IxNDA2MDA2LDEwNTU0NDU0NzIsLTk4OTAyMzAwNSwtMTc2ODEz
MTg4NSwyMDIwMTM4NjMxLDEzMDkyMjcwNjksMTkwMzAzNjk5NC
wtMzAzMzU3Mjg0LDc5MDkzOTMzNCwtNTUyNjMwNDQ5LC01NTI1
MzY2MzAsNDI5NTg4MjI3LDgwMTAzMjk2OCw3MzA5OTgxMTZdfQ
==
-->