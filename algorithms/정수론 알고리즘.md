...
한 합성수를 소수들의 곱으로 표현하는 방법을 찾는 소인수 분해(prime factorization)도 가끔 볼 수 있는 주제이다. $2$부터  $\sqrt{n}$ 까지 시작해 n의 소인수가 될 수 있는 수들을 하나하나 순회하면서, n의 약수를 찾을때 마다 n을 이 숫자로 나눈다.

 

> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ1OTU4ODM3MSwyMDIwMTM4NjMxLDEzMD
kyMjcwNjksMTkwMzAzNjk5NCwtMzAzMzU3Mjg0LDc5MDkzOTMz
NCwtNTUyNjMwNDQ5LC01NTI1MzY2MzAsNDI5NTg4MjI3LDgwMT
AzMjk2OCw3MzA5OTgxMTZdfQ==
-->