...
예로 100을 $4 *25$로 표현하는 경우를 생각해보자. $25 >= \sqrt{100} >= 4$가 성립한다. 즉 $n$값을 이루는 작은값이 어떤 값인지는 정확히는 모르겠으나 $\sqrt{n}$ 보다 같거나 작은것은 확실하기 때문에 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzIzNDAyMDI2LDE5MDMwMzY5OTQsLTMwMz
M1NzI4NCw3OTA5MzkzMzQsLTU1MjYzMDQ0OSwtNTUyNTM2NjMw
LDQyOTU4ODIyNyw4MDEwMzI5NjgsNzMwOTk4MTE2XX0=
-->