...
주어진 숫자 n이하의 숫자 중에서 소수를 구하는 알고리즘이다. 간단한 방법은 2 ~ n까지의 모든 숫자를 소수인지 판별하여 계산해보는 것이다. 일일이 모든 숫자를 소수 판별하는 대신에, 소수로 판별된 숫자가 있으면 그 숫자의 배수는 모두 합성수이다. 왜냐하면, 소수의 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg1ODU4NDk0NSwtMTA2ODk0NzcyMywtMT
