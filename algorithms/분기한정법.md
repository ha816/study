...
분기(branching) 
: 분기는 가능영역(feasible region)에서 여러 개의 작은 하위영역(feasible subregion)을 구성한다. 이 subregion 각각에 대해 재귀 반복 과정을 거치고, 만들어진 subregion 들이 자연스럽게 search tree 또는 branch-and-bound-tree 라고 불리는 tree 구조를 형성하기 때문이다. 그 노드들 각자가 subregion 이 되는 것이다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcwMTk0Nzg1MiwtNTc0MTgxMTE5LC0xMD
I1NTAwOTUzXX0=
-->