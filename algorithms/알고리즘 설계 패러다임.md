...
무슨말인지 binomial2 로 설명해보자면, 먼저 r의 최대치는 n이기 때문에 만나는 부분 문제의 수는  최대로 $O(n^2)$이다. 각 부분 문제에는 반복문이 없어 $O(1)$이다. 따라서 bion2(n,r)을 계산하는데 걸리는 시간 복잡도는 $O(n^2)$이다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkyMTg0MDM2LC03Mjk5NDcwNzYsMjQ2Mz
Q1MDM1LC0xMjkwODg1NjAsLTEyODA4OTQ2ODUsNDc3NTQxMzg4
LC0xMzE1Mzk5MzQxLDE3MDkyNzA2MTAsLTExMTA5NjU2NTcsLT
E2NDY5NDEzODEsLTg4ODMxMTI4Miw1MTE3NTcxMjYsNjYxNjQx
NTIxLC0xNTcyODMzNDZdfQ==
-->