...
이렇게 결과를 저장하는 장소를 마련해두고, 계산한 값을 저장 재활용하는 최적화 기법을 [메모이제이션(memoization)](https://ko.wikipedia.org/wiki/%EB%A9%94%EB%AA%A8%EC%9D%B4%EC%A0%9C%EC%9D%B4%EC%85%98)이라고 한다. 메모라이제이션이라고 잘못 사용하는 경우가 많은데 메모이 제이션이 옳은 표현이다 . 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYxMjMxMjUyNywtMTk1NDUxOTgzOCwtMz
