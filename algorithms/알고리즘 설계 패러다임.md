...
무슨말인지 binomial2 로 설명해보자면, 먼저 r의 최대치는 n이기 때문에 만나는 부분 문제의 수는  최대로 $O(n^2)$이다. 메모이제이션을 사용하기 때문에 재귀함수의 중복 호추사실 실제 계산은 $n * n$이다. 

각 부분 문제에는 반복문이 없어 $O(1)$이다. 따라서 bion2(n,r)을 계산하는데 걸리는 시간 복잡도는 $O(n^2)$이다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI1MTg3MjY2NSwtOTIxODQwMzYsLTcyOT
k0NzA3NiwyNDYzNDUwMzUsLTEyOTA4ODU2MCwtMTI4MDg5NDY4
NSw0Nzc1NDEzODgsLTEzMTUzOTkzNDEsMTcwOTI3MDYxMCwtMT
ExMDk2NTY1NywtMTY0Njk0MTM4MSwtODg4MzExMjgyLDUxMTc1
NzEyNiw2NjE2NDE1MjEsLTE1NzI4MzM0Nl19
-->