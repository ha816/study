...
$G$를 연결되고, 가중치가 주어진 그래프를 말하고 $Y$를 Krukal 방법으로 만들어진 subgraph라고 하자. {\displaystyle Y}![Y](https://wikimedia.org/api/rest_v1/media/math/render/svg/961d67d6b454b4df2301ac571808a3538b3a6d3f) cannot have a cycle, being within one subtree and not between two different trees
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzE4OTI2NzQxLC05MDc3MTExODUsLTE5Mz
