...
반면에 $e$가 MST에 포함되지 않으면, $T+e$은 cycle $C$를 가지게 된다. 이 cycle은 $F$에 포함되지 않은 간선을 가진다. 왜냐하면 $e$가 $F$에서는 cycle을 가지지 아
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MjE2ODYyMTcsOTczMTE4NTQ0LC00MD
