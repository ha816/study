...
모든 노드들이 연결되어 있고, 가중치가 주어진 그래프 $G$가 주어졌다고 하자. 알고리즘은 모든 간선을 하나씩 검토하고 그중에 기존에 신장트리에 간선을 추가했을때 cycle을 생성하는 경우를 제거한다. 그리고 그래프 G의 모든 노드들은 서로 연결 가능하기 때문에 결과는 반드시 모든 노드와 연결가능되지만, cycle은 없는  즉 spanningTree를 만족한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTc1MDA5Nzk0LDU3MzA1MjQ1NywtOTA3Nz
ExMTg1LC0xOTMyMTg1MDA1LC0yMTA4NzQxOTY5LDU5NjI0MzU4
NCwtNzM3NTM5NzAxLDY1NjQyMTIzOSwxNTU4Njg0MzUyLC0xMT
E2ODg3OTEsODkzNzk5OTI3LDExMjU5OTA4MDcsLTM2OTA1OTc0
OCw4MzQ3NTI3MTYsLTU0Njg1NzYyNywxMDA4NzkxOTcyLDE0MT
A1NjgyMjgsLTY2MTQ3NzM1Myw2Mjg0MzMyMiwtNDUyMDQ3NTAw
XX0=
-->