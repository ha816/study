...
반면에 $e$가 MST에 포함되지 않으면, $T+e$은 cycle $C$를 가지게 된다. 이 cycle은 $F$에 포함되지 않은 간선을 가진다. 왜냐하면 $e$가 $F$에서는 cycle을 가지지 않지만 $T$에선 가지기 때문이다. $f$를 $C$에 있지만 $F$에는 없는 하나의 간선이라고 하자. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg4MDY4MDk2Miw5NzMxMTg1NDQsLTQwND
A4MjA4LDk3NTAwOTc5NCw1NzMwNTI0NTcsLTkwNzcxMTE4NSwt
MTkzMjE4NTAwNSwtMjEwODc0MTk2OSw1OTYyNDM1ODQsLTczNz
UzOTcwMSw2NTY0MjEyMzksMTU1ODY4NDM1MiwtMTExNjg4Nzkx
LDg5Mzc5OTkyNywxMTI1OTkwODA3LC0zNjkwNTk3NDgsODM0Nz
UyNzE2LC01NDY4NTc2MjcsMTAwODc5MTk3MiwxNDEwNTY4MjI4
XX0=
-->