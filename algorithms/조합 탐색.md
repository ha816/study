...
모든 노드들이 연결되어 있고, 가중치가 주어진 그래프 $G$가 주어졌다고 하자. 알고리즘은 모든 간선을 하나씩 검토하고 그중에 기존에 신장트리에 간선을 추가했을때 cycle을 생성하는 경우를 제거한다. 그리고 그래프 G의 모든 노드들은 서로 연결 가능하기 때문에 알고리즘의 결과는 모든 노드와 연결가능하지만, cycle은 없는 트리가 된다. 즉 결과는 spanningTree를 만족한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQwNDA4MjA4LDk3NTAwOTc5NCw1NzMwNT
I0NTcsLTkwNzcxMTE4NSwtMTkzMjE4NTAwNSwtMjEwODc0MTk2
OSw1OTYyNDM1ODQsLTczNzUzOTcwMSw2NTY0MjEyMzksMTU1OD
Y4NDM1MiwtMTExNjg4NzkxLDg5Mzc5OTkyNywxMTI1OTkwODA3
LC0zNjkwNTk3NDgsODM0NzUyNzE2LC01NDY4NTc2MjcsMTAwOD
c5MTk3MiwxNDEwNTY4MjI4LC02NjE0NzczNTMsNjI4NDMzMjJd
fQ==
-->