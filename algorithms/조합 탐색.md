...
모든 노드들이 연결되어 있고, 가중치가 주어진 그래프 $G$가 주어졌을때, $Y$를 Krukal 방법으로 만들어진 결과 최소신장트리 MST라고 하자.  그러면 정의에 따라서 $Y$는 cycle이 없고 하나의 트리로만 구성이 된다. $Y$는 모든 노드를 가기 때문에 disconnected할 수 없다. 왜냐하면, $Y$의 두 노드를 합친 가장 먼저 마주한 간선이 이미 알고리즘에서 더해졌기 때문에
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk0ODM1MTYyMSwtOTA3NzExMTg1LC0xOT
MyMTg1MDA1LC0yMTA4NzQxOTY5LDU5NjI0MzU4NCwtNzM3NTM5
NzAxLDY1NjQyMTIzOSwxNTU4Njg0MzUyLC0xMTE2ODg3OTEsOD
kzNzk5OTI3LDExMjU5OTA4MDcsLTM2OTA1OTc0OCw4MzQ3NTI3
MTYsLTU0Njg1NzYyNywxMDA4NzkxOTcyLDE0MTA1NjgyMjgsLT
Y2MTQ3NzM1Myw2Mjg0MzMyMiwtNDUyMDQ3NTAwLC0xNDUwOTk1
OTU4XX0=
-->