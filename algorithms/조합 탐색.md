...
모든 노드들이 연결되어 있고, 가중치가 주어진 그래프 $G$가 주어졌다고 하자. 알고리즘은 모든 간선을 하나씩 검토하고 그중에 기존에 신장트리에 간선을 추가했을때 cycle을 생성하는 경우를 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk4MjI5MTcwMyw1NzMwNTI0NTcsLTkwNz
