...
$from$은 시작노드 또는 현재 노드를 말하고 $visited$는 지금까지 방문한 노드들을 말한다. 따라서 $getMinCost(from, visited)$는 시작 노드가 from이고 지금까지 방문한 $visited$가 주어졌을때,  from에서 시작해 visited를 제외한 나머지 모든 노드들을 방문하는  경로합이 최소인 값을 반환한다. 앞선 완전탐색 점화식과 다르게 $paths$ 대신 $visited$를 사용한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc1NjkwNjMxLC0zOTMzNzYxMTUsLTE2OT
k1ODUyNTksMTkxMzIyODAzMCwtMTg1NTU2MDIsMjA5MDgxNzA5
NywtMTgxMTM2MzExMSwtMTc0MDk1MDE5NywtMjAxODMyMjQ5NS
wtMTgyMTIyNDU5MSw1MDY2NTgwNDMsODk2NDM1NTE5LDU4MTk0
OTg3NywtMTc1OTU5NTU5NSwtMTgwMTY0NzUxOSwxMzAzNzY3Nj
U5LC05Mzc1OTgxMzAsLTQ2NTE0NDIyNiw3ODU0NzIxNCwtMjM2
MDMzODE4XX0=
-->