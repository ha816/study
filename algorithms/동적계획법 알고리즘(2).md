...
### brute-force 접근법
먼저 간단히 모든 경로를 가는 brute-force방식의 접근을 생각해보자. 
...
본 알고리즘은 모든 가능한 경로를 모두 고려하기 때문에 시간 복잡도가 $O(n!$)이다. 

### 동적계획 방법

이제 문제에 약간의 변형을 가하자. $p$에서 $q$로 가는데는 최소 하나 이상의 경

$$minCostPath(Paths)= \min_{n \in targetNodes}  \begin{cases}  minCostPaths(Paths + n) 
 \end{cases}$$


> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI0NDI0OTM5Myw3ODU0NzIxNCwtMjM2MD
MzODE4LDE2MDQwOTk2ODAsLTE2NDYyODMwNTAsLTMzNTg4OTMy
OCwtMTYwNjA5MTM1MCwtMTE1ODcwOTg2NSwxMzM2NjY2Nzg5LD
IyODE2NzU5NSwtMTkwNDI2NjQ0LC03OTIxMDg1ODIsLTE0NDQ4
MDI2MjEsMTcyOTkwNjg1MCwtMTgyMTg3ODM2MSwyOTk3MTc3Nz
MsMTIwNDQ1ODk0MiwxNDMxNjM1NDA5LDQ5OTk0MzUwMyw3NjU0
MjIzNTRdfQ==
-->