...
pack(params, p_{i+1}) \end{cases}, \text{and}\  V(p

$params$에는 호출 전에 가방에 넣은 물품들을 말하며, $p_i$는 이번 차례에 넣을지 말지 고민하는 물품을 말한다. arams) <= W $$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NDQ4MDI2MjEsMTcyOTkwNjg1MCwtMT
gyMTg3ODM2MSwyOTk3MTc3NzMsMTIwNDQ1ODk0MiwxNDMxNjM1
