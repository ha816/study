...
$from$은 시작노드 또는 현재 노드를 말하고 $visited$는 지금까지 방문한 노드들을 말한다. 따라서 $getMinCost(from, visited)$는 시작 노드가 from이고 지금까지 방문한 $visited$가 주어졌을때,  from에서 시작해 visited를 제외한 나머지 모든 노드들을 방문하는 경로의 최소 길이를 반환한다. 앞선 완전탐색 점화식과 다르게 $paths$ 대신 $visited$를 사용한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MzA5Nzg5MTAsLTM5MzM3NjExNSwtMT
Y5OTU4NTI1OSwxOTEzMjI4MDMwLC0xODU1NTYwMiwyMDkwODE3
MDk3LC0xODExMzYzMTExLC0xNzQwOTUwMTk3LC0yMDE4MzIyND
k1LC0xODIxMjI0NTkxLDUwNjY1ODA0Myw4OTY0MzU1MTksNTgx
OTQ5ODc3LC0xNzU5NTk1NTk1LC0xODAxNjQ3NTE5LDEzMDM3Nj
c2NTksLTkzNzU5ODEzMCwtNDY1MTQ0MjI2LDc4NTQ3MjE0LC0y
MzYwMzM4MThdfQ==
-->