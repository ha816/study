...
위 점화식 1번은 개선이 가능하다. 바로 최적부분 구조에 맞게 고치는 것인데 현재까지 더해온 $paths$ 대신 visited를 한 도시를 제외한 임의의 current 도시로 부터 next 도시로 가는 최소한의 경로를 계산한다. 

$$TPS(current, visited)$$$$= \min({TPS(next, visited + next) + distance[current][next]})$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MjEyMjQ1OTEsNTA2NjU4MDQzLDg5Nj
QzNTUxOSw1ODE5NDk4NzcsLTE3NTk1OTU1OTUsLTE4MDE2NDc1
MTksMTMwMzc2NzY1OSwtOTM3NTk4MTMwLC00NjUxNDQyMjYsNz
g1NDcyMTQsLTIzNjAzMzgxOCwxNjA0MDk5NjgwLC0xNjQ2Mjgz
MDUwLC0zMzU4ODkzMjgsLTE2MDYwOTEzNTAsLTExNTg3MDk4Nj
UsMTMzNjY2Njc4OSwyMjgxNjc1OTUsLTE5MDQyNjY0NCwtNzky
MTA4NTgyXX0=
-->