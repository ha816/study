...
$getMinCost(from, visited)$는 from에서 시작하여 visited를 제외한 모든 노드들을 탐색하는 경로들 중 제일 경로값이 작은 값을 반환한다. 현재까지 더해온 $paths$ 대신 visited를 사용한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU2MTk4NDY0MCwtMTg1NTU2MDIsMjA5MD
