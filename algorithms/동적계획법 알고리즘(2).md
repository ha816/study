...
여행을 위해서 캐리어 가방을 싸려고 한다. 규정상 캐리어는 하나만 가져 갈 수 있고 가져라고 싶은 물건들의 부피와 얼마나 필요한지를 나타내는 필요도를 조사해 다음과 같은 목록을 만들었습니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAzMTg1NDEzMSwxMzU0Mzc2OTgsMjA5Nj
