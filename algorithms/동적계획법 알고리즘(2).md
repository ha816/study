...
$getMinCost(from, visited)$는 visited를 제외한 모든 노드들을 탐색하는 경로들 중 from에서 시작하고 경로값이 최소인 값을 반환한다. 앞선 완전탐색 점화식과 다르게 $paths$ 대신 $visited$를 사용한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzOTUwOTc3NTEsLTE4NTU1NjAyLDIwOT
