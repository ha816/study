...
$$variance = \frac{1}{b-a+1} \sum_{i=a}^{b} (A[i]- m_{a,b})^2$$$$= \frac{1}{b-a+1} \sum_{i=a}^{b} (A[i]^2 - 2A[i] m_{a,b}+ {m_{a,b}}^2)$$$$= \frac{1}{b-a+1}( \sum_{i=a}^{b} A[i]^2 - 2 m_{a,b}A[i]+ {m_{a,b}}^2)$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzE1NDAwNDc2LDYxNjM4MTA5OCwtMjExMD
g4Mzk3NSwxODI3MjgzNTQyXX0=
-->